...
DOCUMENTATION = """
---
module: fortios_firewall_internet_service_sld
short_description: Internet Service Second Level Domain in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify firewall feature and internet_service_sld category.
...
options:
    ...
    firewall_internet_service_sld:
        ...
        suboptions:
            id:
                description:
                    - Second Level Domain ID. see <a href='#notes'>Notes</a>.
                required: true
                type: int
            name:
                description:
...
def firewall_internet_service_sld(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey(
            "firewall", "internet-service-sld", filtered_data, vdom=vdom
        )
    ...
    data_copy = data.copy()
    data_copy["firewall_internet_service_sld"] = filtered_data
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_internet_service_sld"]:
        resp = firewall_internet_service_sld(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("firewall_internet_service_sld")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_internet_service_sld"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_internet_service_sld"
        )
