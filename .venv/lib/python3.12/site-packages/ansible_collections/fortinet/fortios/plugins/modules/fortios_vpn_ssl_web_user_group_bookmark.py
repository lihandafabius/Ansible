...
short_description: Configure Agentless VPN user group bookmark in Fortinet's FortiOS and FortiGate.
description:
...
def vpn_ssl_web_user_group_bookmark(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["vpn_ssl_web_user_group_bookmark"] = filtered_data
