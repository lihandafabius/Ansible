...
DOCUMENTATION = """
---
module: fortios_credential_store_domain_controller
short_description: Define known domain controller servers in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify credential_store feature and domain_controller category.
...
def credential_store_domain_controller(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey(
            "credential-store", "domain-controller", filtered_data, vdom=vdom
        )
    ...
    data_copy = data.copy()
    data_copy["credential_store_domain_controller"] = filtered_data
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["credential_store_domain_controller"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "credential_store_domain_controller"
        )

        is_error, has_changed, result, diff = fortios_credential_store(
