...
def wireless_controller_hotspot20_anqp_roaming_consortium(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["wireless_controller_hotspot20_anqp_roaming_consortium"] = filtered_data
...
def fortios_wireless_controller_hotspot20(data, fos, check_mode):
    ...
    if data["wireless_controller_hotspot20_anqp_roaming_consortium"]:
        resp = wireless_controller_hotspot20_anqp_roaming_consortium(
            data, fos, check_mode
        )
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_hotspot20_anqp_roaming_consortium"]["options"][
            attribute_name
