...
def wireless_controller_hotspot20_h2qp_osu_provider(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["wireless_controller_hotspot20_h2qp_osu_provider"] = filtered_data
    ...
    "children": {
        ...
        "friendly_name": {
            ...
            "children": {
                ...
                "friendly_name": {"v_range": [["v6.0.0", ""]], "type": "string"},
            },
            "v_range": [["v6.0.0", ""]],
        },
        "server_uri": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "osu_method": {
            "v_range": [["v6.0.0", ""]],
            "type": "list",
            "options": [
        ...
        "osu_nai": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "service_description": {
            "type": "list",
            "elements": "dict",
            "children": {
                ...
                "lang": {"v_range": [["v6.0.0", ""]], "type": "string"},
                "service_description": {"v_range": [["v6.0.0", ""]], "type": "string"},
            },
            "v_range": [["v6.0.0", ""]],
        },
        "icon": {"v_range": [["v6.0.0", ""]], "type": "string"},
    },
    "v_range": [["v6.0.0", ""]],
}
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_hotspot20_h2qp_osu_provider"]["options"][
            attribute_name
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "wireless_controller_hotspot20_h2qp_osu_provider"
        )
