...
DOCUMENTATION = """
---
module: fortios_wireless_controller_ssid_policy
short_description: Configure WiFi SSID policies in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify wireless_controller feature and ssid_policy category.
...
def filter_wireless_controller_ssid_policy_data(json):
...
def wireless_controller_ssid_policy(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey(
            "wireless-controller", "ssid-policy", filtered_data, vdom=vdom
        )
    ...
    data_copy = data.copy()
    data_copy["wireless_controller_ssid_policy"] = filtered_data
...
def fortios_wireless_controller(data, fos, check_mode):
    ...
    if data["wireless_controller_ssid_policy"]:
        resp = wireless_controller_ssid_policy(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("wireless_controller_ssid_policy")
        )
...
versioned_schema = {
    ...
    "children": {
        ...
        "vlan": {"v_range": [["v7.0.0", ""]], "type": "string"},
    },
    "v_range": [["v7.0.0", ""]],
}
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_ssid_policy"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "wireless_controller_ssid_policy"
        )
