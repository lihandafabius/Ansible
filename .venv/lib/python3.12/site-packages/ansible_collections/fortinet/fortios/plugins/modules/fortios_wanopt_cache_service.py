...
def wanopt_cache_service(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["wanopt_cache_service"] = filtered_data
...
def fortios_wanopt(data, fos, check_mode):
    ...
    if data["wanopt_cache_service"]:
        resp = wanopt_cache_service(data, fos, check_mode)
    else:
...
versioned_schema = {
    ...
    "children": {
        ...
        "device_id": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "acceptable_connections": {
            "v_range": [["v6.0.0", ""]],
            "type": "string",
            "options": [{"value": "any"}, {"value": "peers"}],
        },
        "dst_peer": {
            "type": "list",
            "elements": "dict",
            "children": {
                ...
                "auth_type": {"v_range": [["v6.0.0", ""]], "type": "integer"},
                "encode_type": {"v_range": [["v6.0.0", ""]], "type": "integer"},
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wanopt_cache_service"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "wanopt_cache_service"
        )
