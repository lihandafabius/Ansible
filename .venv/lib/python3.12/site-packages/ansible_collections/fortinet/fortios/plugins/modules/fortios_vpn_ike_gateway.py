...
DOCUMENTATION = """
---
module: fortios_vpn_ike_gateway
short_description: List gateways in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify vpn_ike feature and gateway category.
...
def vpn_ike_gateway(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["vpn_ike_gateway"] = filtered_data
...
def fortios_vpn_ike(data, fos, check_mode):

    if data["vpn_ike_gateway"]:
        resp = vpn_ike_gateway(data, fos, check_mode)
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["vpn_ike_gateway"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
        if mkeyname and mkeyname == attribute_name:
            fields["vpn_ike_gateway"]["options"][attribute_name]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "vpn_ike_gateway"
        )

        is_error, has_changed, result, diff = fortios_vpn_ike(
