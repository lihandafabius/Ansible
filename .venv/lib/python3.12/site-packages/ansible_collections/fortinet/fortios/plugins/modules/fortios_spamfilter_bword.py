        ...
        suboptions:
            ...
            entries:
                ...
                suboptions:
                    ...
                    id:
                        description:
                            - Banned word entry ID. see <a href='#notes'>Notes</a>.
                        required: true
                        type: int
                    language:
                        description:
...
def spamfilter_bword(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("spamfilter", "bword", filtered_data, vdom=vdom)
        current_data = fos.get(
            "spamfilter", "bword", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
    ...
    data_copy = data.copy()
    data_copy["spamfilter_bword"] = filtered_data
    ...
    if state == "present" or state is True:
        return fos.set(
            "spamfilter", "bword", data=converted_data, vdom=vdom, parameters=parameters
        )
...
def fortios_spamfilter(data, fos, check_mode):
    ...
    if data["spamfilter_bword"]:
        resp = spamfilter_bword(data, fos, check_mode)
    else:
        fos._module.fail_json(msg="missing task body: %s" % ("spamfilter_bword"))
    ...
    "children": {
        ...
        "entries": {
            ...
            "children": {
                ...
                "pattern": {"v_range": [["v6.0.0", "v6.0.11"]], "type": "string"},
                "pattern_type": {
                    "v_range": [["v6.0.0", "v6.0.11"]],
                    "type": "string",
                ...
                "action": {
                    "v_range": [["v6.0.0", "v6.0.11"]],
                    "type": "string",
                    "options": [{"value": "spam"}, {"value": "clear"}],
                },
                "where": {
                    "v_range": [["v6.0.0", "v6.0.11"]],
                    "type": "string",
                ...
                "score": {"v_range": [["v6.0.0", "v6.0.11"]], "type": "integer"},
            },
            "v_range": [["v6.0.0", "v6.0.11"]],
        },
    },
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["spamfilter_bword"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
        if mkeyname and mkeyname == attribute_name:
            fields["spamfilter_bword"]["options"][attribute_name]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "spamfilter_bword"
        )
