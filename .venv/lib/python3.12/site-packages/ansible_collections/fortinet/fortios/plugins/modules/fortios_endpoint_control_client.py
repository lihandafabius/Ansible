...
options:
    ...
    endpoint_control_client:
        ...
        suboptions:
            ...
            id:
                description:
                    - Endpoint client ID. see <a href='#notes'>Notes</a>.
                required: true
                type: int
            info:
                description:
...
def filter_endpoint_control_client_data(json):
    option_list = ["ad_groups", "ftcl_uid", "id", "info", "src_ip", "src_mac"]
...
def endpoint_control_client(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["endpoint_control_client"] = filtered_data
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["endpoint_control_client"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["endpoint_control_client"]["options"][attribute_name][
                "required"
            ] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "endpoint_control_client"
        )
