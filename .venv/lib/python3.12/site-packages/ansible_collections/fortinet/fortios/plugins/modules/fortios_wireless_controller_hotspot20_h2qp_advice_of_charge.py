...
def wireless_controller_hotspot20_h2qp_advice_of_charge(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["wireless_controller_hotspot20_h2qp_advice_of_charge"] = filtered_data
...
def fortios_wireless_controller_hotspot20(data, fos, check_mode):
    ...
    if data["wireless_controller_hotspot20_h2qp_advice_of_charge"]:
        resp = wireless_controller_hotspot20_h2qp_advice_of_charge(
            data, fos, check_mode
        )
    else:
    ...
    "children": {
        ...
        "aoc_list": {
            ...
            "children": {
                ...
                "nai_realm_encoding": {"v_range": [["v7.0.2", ""]], "type": "string"},
                "nai_realm": {"v_range": [["v7.0.2", ""]], "type": "string"},
                "plan_info": {
                    "type": "list",
                    "elements": "dict",
                    "children": {
                        ...
                        "lang": {"v_range": [["v7.0.2", ""]], "type": "string"},
                        "currency": {"v_range": [["v7.0.2", ""]], "type": "string"},
                        "info_file": {"v_range": [["v7.0.2", ""]], "type": "string"},
                    },
                    "v_range": [["v7.0.2", ""]],
                },
            },
