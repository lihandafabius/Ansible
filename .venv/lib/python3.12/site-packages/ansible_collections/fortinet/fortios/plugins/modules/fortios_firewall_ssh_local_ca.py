...
def firewall_ssh_local_ca(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["firewall_ssh_local_ca"] = filtered_data
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_ssh_local_ca"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["firewall_ssh_local_ca"]["options"][attribute_name][
                "required"
            ] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_ssh_local_ca"
        )
