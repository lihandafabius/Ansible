...
DOCUMENTATION = """
---
module: fortios_user_scim
short_description: Configure SCIM client entries in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify user feature and scim category.
...
options:
    ...
    user_scim:
        ...
        suboptions:
            ...
            client_secret_token:
                description:
                    - Client secret token for authentication.
                type: str
            id:
                description:
                    - SCIM client ID.
...
def user_scim(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        current_data = fos.get(
            "user", "scim", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
    ...
    if state == "present" or state is True:
        return fos.set(
            "user", "scim", data=converted_data, vdom=vdom, parameters=parameters
        )
...
versioned_schema = {
    ...
    "children": {
        ...
        "id": {"v_range": [["v7.6.0", ""]], "type": "integer"},
        "status": {
            "v_range": [["v7.6.0", ""]],
            "type": "string",
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["user_scim"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
