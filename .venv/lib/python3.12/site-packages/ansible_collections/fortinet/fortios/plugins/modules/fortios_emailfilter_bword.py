...
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify emailfilter feature and bword category.
...
def emailfilter_bword(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["emailfilter_bword"] = filtered_data
...
def fortios_emailfilter(data, fos, check_mode):
    ...
    if data["emailfilter_bword"]:
        resp = emailfilter_bword(data, fos, check_mode)
    else:
        fos._module.fail_json(msg="missing task body: %s" % ("emailfilter_bword"))
    ...
    "children": {
        ...
        "entries": {
            ...
            "children": {
                ...
                "pattern": {"v_range": [["v6.2.0", ""]], "type": "string"},
                "pattern_type": {
                    "v_range": [["v6.2.0", ""]],
                    "type": "string",
                ...
                "score": {"v_range": [["v6.2.0", ""]], "type": "integer"},
            },
            "v_range": [["v6.2.0", ""]],
        },
    },
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["emailfilter_bword"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
        if mkeyname and mkeyname == attribute_name:
            fields["emailfilter_bword"]["options"][attribute_name]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "emailfilter_bword"
        )
