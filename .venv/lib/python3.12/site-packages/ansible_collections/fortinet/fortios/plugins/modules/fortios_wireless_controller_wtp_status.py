...
DOCUMENTATION = """
---
module: fortios_wireless_controller_wtp_status
short_description: Wireless controller WTP-status in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify wireless_controller feature and wtp_status category.
...
def wireless_controller_wtp_status(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["wireless_controller_wtp_status"] = filtered_data
...
def fortios_wireless_controller(data, fos, check_mode):
    ...
    if data["wireless_controller_wtp_status"]:
        resp = wireless_controller_wtp_status(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("wireless_controller_wtp_status")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_wtp_status"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "wireless_controller_wtp_status"
        )
