...
DOCUMENTATION = """
---
module: fortios_firewall_vendor_mac
short_description: Show vendor and the MAC address they have in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify firewall feature and vendor_mac category.
...
options:
    ...
    firewall_vendor_mac:
        ...
        suboptions:
            id:
                description:
                    - Vendor ID. see <a href='#notes'>Notes</a>.
                required: true
                type: int
            mac_number:
                description:
...
def firewall_vendor_mac(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("firewall", "vendor-mac", filtered_data, vdom=vdom)
        current_data = fos.get(
            "firewall", "vendor-mac", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
    ...
    data_copy = data.copy()
    data_copy["firewall_vendor_mac"] = filtered_data
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_vendor_mac"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["firewall_vendor_mac"]["options"][attribute_name]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_vendor_mac"
        )
