...
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify emailfilter feature and mheader category.
...
def filter_emailfilter_mheader_data(json):
    option_list = [
        "comment",
        "entries",
        "fabric_force_sync",
...
def emailfilter_mheader(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["emailfilter_mheader"] = filtered_data
...
def fortios_emailfilter(data, fos, check_mode):
    ...
    if data["emailfilter_mheader"]:
        resp = emailfilter_mheader(data, fos, check_mode)
    else:
        fos._module.fail_json(msg="missing task body: %s" % ("emailfilter_mheader"))
    ...
    "children": {
        ...
        "entries": {
            ...
            "children": {
                ...
                "fieldname": {"v_range": [["v6.2.0", ""]], "type": "string"},
                "fieldbody": {"v_range": [["v6.2.0", ""]], "type": "string"},
                "pattern_type": {
                    "v_range": [["v6.2.0", ""]],
                    "type": "string",
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["emailfilter_mheader"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "emailfilter_mheader"
        )
