...
options:
    ...
    firewall_multicast_policy6:
        ...
        suboptions:
            ...
            dstintf:
                description:
                    - IPv6 destination interface name. Source system.interface.name system.zone.name system.sdwan.zone.name.
                type: str
            end_port:
                description:
            ...
            srcintf:
                description:
                    - IPv6 source interface name. Source system.interface.name system.zone.name system.sdwan.zone.name.
                type: str
            start_port:
                description:
...
def firewall_multicast_policy6(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        current_data = fos.get(
            "firewall", "multicast-policy6", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
    ...
    data_copy = data.copy()
    data_copy["firewall_multicast_policy6"] = filtered_data
