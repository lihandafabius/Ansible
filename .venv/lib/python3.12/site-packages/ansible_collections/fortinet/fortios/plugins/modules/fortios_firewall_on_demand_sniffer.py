...
def firewall_on_demand_sniffer(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["firewall_on_demand_sniffer"] = filtered_data
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_on_demand_sniffer"]:
        resp = firewall_on_demand_sniffer(data, fos, check_mode)
    else:
