...
def ips_rule_settings(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["ips_rule_settings"] = filtered_data
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["ips_rule_settings"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
        if mkeyname and mkeyname == attribute_name:
            fields["ips_rule_settings"]["options"][attribute_name]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "ips_rule_settings"
        )
