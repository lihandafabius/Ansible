...
DOCUMENTATION = """
---
module: fortios_firewall_internet_service_addition
short_description: Configure Internet Services Addition in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify firewall feature and internet_service_addition category.
...
def filter_firewall_internet_service_addition_data(json):
    option_list = ["comment", "entry", "id"]
...
def firewall_internet_service_addition(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey(
            "firewall", "internet-service-addition", filtered_data, vdom=vdom
        )
    ...
    data_copy = data.copy()
    data_copy["firewall_internet_service_addition"] = filtered_data
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_internet_service_addition"]:
        ...
        fos._module.fail_json(
            msg="missing task body: %s" % ("firewall_internet_service_addition")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_internet_service_addition"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_internet_service_addition"
        )
