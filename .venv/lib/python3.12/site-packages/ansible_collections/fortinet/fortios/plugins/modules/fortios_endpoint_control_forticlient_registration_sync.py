...
def endpoint_control_forticlient_registration_sync(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["endpoint_control_forticlient_registration_sync"] = filtered_data
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["endpoint_control_forticlient_registration_sync"]["options"][
            attribute_name
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "endpoint_control_forticlient_registration_sync"
        )
