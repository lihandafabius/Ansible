...
def endpoint_control_registered_forticlient(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey(
            "endpoint-control", "registered-forticlient", filtered_data, vdom=vdom
        )
    ...
    data_copy = data.copy()
    data_copy["endpoint_control_registered_forticlient"] = filtered_data
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["endpoint_control_registered_forticlient"]["options"][attribute_name] = (
            module_spec["options"][attribute_name]
        )
        if mkeyname and mkeyname == attribute_name:
            fields["endpoint_control_registered_forticlient"]["options"][
                attribute_name
            ]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "endpoint_control_registered_forticlient"
        )
