...
options:
    ...
    nsxt_service_chain:
        ...
        suboptions:
            id:
                description:
                    - Chain ID. see <a href='#notes'>Notes</a>.
                required: true
                type: int
            name:
                description:
            ...
            service_index:
                ...
                suboptions:
                    id:
                        description:
                            - Service index. see <a href='#notes'>Notes</a>.
                        required: true
                        type: int
                    name:
                        description:
...
def nsxt_service_chain(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("nsxt", "service-chain", filtered_data, vdom=vdom)
        current_data = fos.get(
            "nsxt", "service-chain", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
    ...
    data_copy = data.copy()
    data_copy["nsxt_service_chain"] = filtered_data
...
def fortios_nsxt(data, fos, check_mode):
    ...
    if data["nsxt_service_chain"]:
        resp = nsxt_service_chain(data, fos, check_mode)
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["nsxt_service_chain"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "nsxt_service_chain"
        )
