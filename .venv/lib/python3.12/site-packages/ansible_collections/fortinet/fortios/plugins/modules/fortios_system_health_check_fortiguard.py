...
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify system feature and health_check_fortiguard category.
...
def filter_system_health_check_fortiguard_data(json):
    option_list = ["name", "protocol", "server"]
...
def system_health_check_fortiguard(data, fos):
    ...
    filtered_data = filter_system_health_check_fortiguard_data(
        system_health_check_fortiguard_data
    )
    ...
    data_copy = data.copy()
    data_copy["system_health_check_fortiguard"] = filtered_data
...
def fortios_system(data, fos):
    ...
    if data["system_health_check_fortiguard"]:
        resp = system_health_check_fortiguard(data, fos)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("system_health_check_fortiguard")
        )
...
versioned_schema = {
    ...
    "children": {
        ...
        "server": {"v_range": [["v7.6.1", ""]], "type": "string"},
        "protocol": {
            "v_range": [["v7.6.1", ""]],
            "type": "string",
            "options": [
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["system_health_check_fortiguard"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "system_health_check_fortiguard"
        )
