...
def wireless_controller_hotspot20_h2qp_wan_metric(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["wireless_controller_hotspot20_h2qp_wan_metric"] = filtered_data
...
def fortios_wireless_controller_hotspot20(data, fos, check_mode):
    ...
    if data["wireless_controller_hotspot20_h2qp_wan_metric"]:
        resp = wireless_controller_hotspot20_h2qp_wan_metric(data, fos, check_mode)
    else:
...
versioned_schema = {
    ...
    "children": {
        ...
        "link_status": {
            "v_range": [["v6.0.0", ""]],
            "type": "string",
            "options": [{"value": "up"}, {"value": "down"}, {"value": "in-test"}],
        },
        "symmetric_wan_link": {
            "v_range": [["v6.0.0", ""]],
            "type": "string",
            "options": [{"value": "symmetric"}, {"value": "asymmetric"}],
        },
        "link_at_capacity": {
            "v_range": [["v6.0.0", ""]],
            "type": "string",
        ...
        "uplink_speed": {"v_range": [["v6.0.0", ""]], "type": "integer"},
        "downlink_speed": {"v_range": [["v6.0.0", ""]], "type": "integer"},
        "uplink_load": {"v_range": [["v6.0.0", ""]], "type": "integer"},
        "downlink_load": {"v_range": [["v6.0.0", ""]], "type": "integer"},
        "load_measurement_duration": {"v_range": [["v6.0.0", ""]], "type": "integer"},
    },
    "v_range": [["v6.0.0", ""]],
}
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_hotspot20_h2qp_wan_metric"]["options"][
            attribute_name
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "wireless_controller_hotspot20_h2qp_wan_metric"
        )
