...
def switch_controller_flow_tracking(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey(
            "switch-controller", "flow-tracking", filtered_data, vdom=vdom
        )
    ...
    data_copy = data.copy()
    data_copy["switch_controller_flow_tracking"] = filtered_data
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    if data["switch_controller_flow_tracking"]:
        resp = switch_controller_flow_tracking(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("switch_controller_flow_tracking")
        )
    ...
    "children": {
        "sample_mode": {
            ...
            "options": [
                {"value": "local"},
                {"value": "perimeter"},
                {"value": "device-ingress"},
            ],
        },
        "sample_rate": {"v_range": [["v6.2.0", ""]], "type": "integer"},
        "format": {
            "v_range": [["v6.2.0", ""]],
            "type": "string",
            "options": [
        ...
        "collectors": {
            ...
            "children": {
                ...
                "ip": {"v_range": [["v7.2.0", ""]], "type": "string"},
                "port": {"v_range": [["v7.2.0", ""]], "type": "integer"},
                "transport": {
                    "v_range": [["v7.2.0", ""]],
                    "type": "string",
        ...
        "max_export_pkt_size": {"v_range": [["v6.2.0", ""]], "type": "integer"},
        "template_export_period": {"v_range": [["v7.2.0", ""]], "type": "integer"},
        "timeout_general": {"v_range": [["v6.2.0", ""]], "type": "integer"},
        "timeout_icmp": {"v_range": [["v6.2.0", ""]], "type": "integer"},
        "timeout_max": {"v_range": [["v6.2.0", ""]], "type": "integer"},
        "timeout_tcp": {"v_range": [["v6.2.0", ""]], "type": "integer"},
        "timeout_tcp_fin": {"v_range": [["v6.2.0", ""]], "type": "integer"},
        "timeout_tcp_rst": {"v_range": [["v6.2.0", ""]], "type": "integer"},
        "timeout_udp": {"v_range": [["v6.2.0", ""]], "type": "integer"},
        "aggregates": {
            "type": "list",
            "elements": "dict",
            "children": {
        ...
        "collector_ip": {"v_range": [["v6.2.0", "v7.0.12"]], "type": "string"},
        "collector_port": {"v_range": [["v6.2.0", "v7.0.12"]], "type": "integer"},
        "transport": {
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_flow_tracking"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_controller_flow_tracking"
        )
