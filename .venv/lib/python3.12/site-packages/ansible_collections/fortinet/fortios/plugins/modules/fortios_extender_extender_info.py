...
DOCUMENTATION = """
---
module: fortios_extender_extender_info
short_description: Display FortiExtender struct information in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify extender feature and extender_info category.
...
def extender_extender_info(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["extender_extender_info"] = filtered_data
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["extender_extender_info"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["extender_extender_info"]["options"][attribute_name][
                "required"
            ] = True
