        ...
        suboptions:
            ...
            entries:
                ...
                suboptions:
                    ...
                    id:
                        description:
                            - Mime header entry ID. see <a href='#notes'>Notes</a>.
                        required: true
                        type: int
                    pattern_type:
                        description:
...
def spamfilter_mheader(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("spamfilter", "mheader", filtered_data, vdom=vdom)
        current_data = fos.get(
            "spamfilter", "mheader", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
    ...
    data_copy = data.copy()
    data_copy["spamfilter_mheader"] = filtered_data
...
def fortios_spamfilter(data, fos, check_mode):
    ...
    if data["spamfilter_mheader"]:
        resp = spamfilter_mheader(data, fos, check_mode)
    else:
        fos._module.fail_json(msg="missing task body: %s" % ("spamfilter_mheader"))
    ...
    "children": {
        ...
        "entries": {
            ...
            "children": {
                ...
                "fieldname": {"v_range": [["v6.0.0", "v6.0.11"]], "type": "string"},
                "fieldbody": {"v_range": [["v6.0.0", "v6.0.11"]], "type": "string"},
                "pattern_type": {
                    "v_range": [["v6.0.0", "v6.0.11"]],
                    "type": "string",
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["spamfilter_mheader"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["spamfilter_mheader"]["options"][attribute_name]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "spamfilter_mheader"
        )
