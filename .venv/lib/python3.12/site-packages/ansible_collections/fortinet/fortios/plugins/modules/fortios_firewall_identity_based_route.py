...
def firewall_identity_based_route(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["firewall_identity_based_route"] = filtered_data
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_identity_based_route"]:
        resp = firewall_identity_based_route(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("firewall_identity_based_route")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_identity_based_route"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_identity_based_route"
        )
