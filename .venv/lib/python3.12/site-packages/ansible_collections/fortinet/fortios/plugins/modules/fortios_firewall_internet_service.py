...
def firewall_internet_service(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("firewall", "internet-service", filtered_data, vdom=vdom)
        current_data = fos.get(
            "firewall", "internet-service", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
    ...
    data_copy = data.copy()
    data_copy["firewall_internet_service"] = filtered_data
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_internet_service"]:
        ...
        fos._module.fail_json(
            msg="missing task body: %s" % ("firewall_internet_service")
        )
...
versioned_schema = {
    ...
    "children": {
        ...
        "direction": {
            "v_range": [["v6.0.0", "v7.0.5"], ["v7.2.0", "v7.2.0"]],
            "type": "string",
            "options": [{"value": "src"}, {"value": "dst"}, {"value": "both"}],
        },
        "database": {
            "v_range": [["v6.0.0", "v7.0.5"], ["v7.2.0", "v7.2.0"]],
            "type": "string",
            "options": [{"value": "isdb"}, {"value": "irdb"}],
        },
        "ip_range_number": {
        ...
        "reputation": {"v_range": [["v6.0.0", "v6.2.7"]], "type": "integer"},
        "sld_id": {"v_range": [["v6.0.0", "v6.2.7"]], "type": "integer"},
        "offset": {"v_range": [["v6.0.0", "v6.0.11"]], "type": "integer"},
        "entry": {
            "type": "list",
            "elements": "dict",
            "children": {
                ...
                "protocol": {"v_range": [["v6.0.0", "v6.0.11"]], "type": "integer"},
                "port": {"v_range": [["v6.0.0", "v6.0.11"]], "type": "integer"},
                "ip_range_number": {
                    "v_range": [["v6.0.0", "v6.0.11"]],
                    "type": "integer",
                },
                "ip_number": {"v_range": [["v6.0.0", "v6.0.11"]], "type": "integer"},
            },
            "v_range": [["v6.0.0", "v6.0.11"]],
        },
    },
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        ...
        if mkeyname and mkeyname == attribute_name:
            fields["firewall_internet_service"]["options"][attribute_name][
                "required"
            ] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_internet_service"
        )
