...
DOCUMENTATION = """
---
module: fortios_antivirus_notification
short_description: Configure AntiVirus notification lists in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify antivirus feature and notification category.
...
options:
    ...
    antivirus_notification:
        ...
        suboptions:
            ...
            entries:
                description:
                    - modify this antivirus notification list
                type: list
                elements: dict
                suboptions:
                    name:
...
def antivirus_notification(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["antivirus_notification"] = filtered_data
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["antivirus_notification"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["antivirus_notification"]["options"][attribute_name][
                "required"
            ] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "antivirus_notification"
        )
