...
DOCUMENTATION = """
---
module: fortios_wireless_controller_client_info
short_description: Wireless controller client-info in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify wireless_controller feature and client_info category.
...
def main():
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "wireless_controller_client_info"
        )
