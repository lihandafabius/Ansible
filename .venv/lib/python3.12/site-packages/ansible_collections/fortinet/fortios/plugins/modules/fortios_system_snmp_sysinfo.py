...
def system_snmp_sysinfo(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["system_snmp_sysinfo"] = filtered_data
...
versioned_schema = {
    ...
    "children": {
        ...
        "engine_id_type": {
            "v_range": [["v7.0.1", ""]],
            "type": "string",
            "options": [{"value": "text"}, {"value": "hex"}, {"value": "mac"}],
        },
        "engine_id": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "description": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "contact_info": {"v_range": [["v6.0.0", ""]], "type": "string"},
