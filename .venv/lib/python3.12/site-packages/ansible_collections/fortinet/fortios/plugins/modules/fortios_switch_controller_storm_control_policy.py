...
DOCUMENTATION = """
---
module: fortios_switch_controller_storm_control_policy
short_description: Configure FortiSwitch storm control policy to be applied on managed-switch ports in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify switch_controller feature and storm_control_policy category.
...
options:
    ...
    switch_controller_storm_control_policy:
        ...
        suboptions:
            broadcast:
                description:
                    - Enable/disable storm control to drop/allow broadcast traffic in override mode.
                type: str
                choices:
                    - 'enable'
                    - 'disable'
            ...
            rate:
                description:
                    - Threshold rate in packets per second at which storm traffic is controlled in override mode .
                type: int
            storm_control_mode:
                description:
            ...
            unknown_multicast:
                description:
                    - Enable/disable storm control to drop/allow unknown multicast traffic in override mode.
                type: str
                choices:
                    - 'enable'
                    - 'disable'
            unknown_unicast:
                description:
                    - Enable/disable storm control to drop/allow unknown unicast traffic in override mode.
                type: str
                choices:
                    - 'enable'
                    - 'disable'
...
def switch_controller_storm_control_policy(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["switch_controller_storm_control_policy"] = filtered_data
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    if data["switch_controller_storm_control_policy"]:
        resp = switch_controller_storm_control_policy(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("switch_controller_storm_control_policy")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_storm_control_policy"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_controller_storm_control_policy"
        )
