...
DOCUMENTATION = """
---
module: fortios_switch_controller_snmp_trap_threshold
short_description: Configure FortiSwitch SNMP trap threshold values globally in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify switch_controller feature and snmp_trap_threshold category.
...
def filter_switch_controller_snmp_trap_threshold_data(json):
    option_list = [
        "trap_high_cpu_threshold",
        "trap_log_full_threshold",
        "trap_low_memory_threshold",
...
def switch_controller_snmp_trap_threshold(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["switch_controller_snmp_trap_threshold"] = filtered_data
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    if data["switch_controller_snmp_trap_threshold"]:
        resp = switch_controller_snmp_trap_threshold(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("switch_controller_snmp_trap_threshold")
        )
...
versioned_schema = {
    ...
    "children": {
        ...
        "trap_low_memory_threshold": {"v_range": [["v6.2.0", ""]], "type": "integer"},
        "trap_log_full_threshold": {"v_range": [["v6.2.0", ""]], "type": "integer"},
    },
}
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_snmp_trap_threshold"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_controller_snmp_trap_threshold"
        )
