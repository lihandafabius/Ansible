...
DOCUMENTATION = """
---
module: fortios_firewall_traffic_class
short_description: Configure names for shaping classes in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify firewall feature and traffic_class category.
...
def firewall_traffic_class(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["firewall_traffic_class"] = filtered_data
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_traffic_class"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["firewall_traffic_class"]["options"][attribute_name][
                "required"
            ] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_traffic_class"
        )
