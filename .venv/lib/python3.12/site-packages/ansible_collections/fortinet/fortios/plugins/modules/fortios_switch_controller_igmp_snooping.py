...
def filter_switch_controller_igmp_snooping_data(json):
    option_list = ["aging_time", "flood_unknown_multicast", "query_interval"]
...
def switch_controller_igmp_snooping(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["switch_controller_igmp_snooping"] = filtered_data
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    if data["switch_controller_igmp_snooping"]:
        resp = switch_controller_igmp_snooping(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("switch_controller_igmp_snooping")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_igmp_snooping"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_controller_igmp_snooping"
        )
