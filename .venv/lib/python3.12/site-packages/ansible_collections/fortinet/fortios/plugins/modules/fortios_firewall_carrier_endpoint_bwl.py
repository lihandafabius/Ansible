...
DOCUMENTATION = """
---
module: fortios_firewall_carrier_endpoint_bwl
short_description: Carrier end point black/white list tables in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify firewall feature and carrier_endpoint_bwl category.
...
def filter_firewall_carrier_endpoint_bwl_data(json):
...
def firewall_carrier_endpoint_bwl(data, fos, check_mode=False):

    state = None
    vdom = data["vdom"]
    parameters = None
    state = data.get("state", None)
    firewall_carrier_endpoint_bwl_data = data["firewall_carrier_endpoint_bwl"]
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey(
            "firewall", "carrier-endpoint-bwl", filtered_data, vdom=vdom
        )
    ...
    data_copy = data.copy()
    data_copy["firewall_carrier_endpoint_bwl"] = filtered_data
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_carrier_endpoint_bwl"]:
        resp = firewall_carrier_endpoint_bwl(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("firewall_carrier_endpoint_bwl")
        )
...
versioned_schema = {
    ...
    "elements": "dict",
    "children": {
        "id": {"v_range": [["v6.0.0", "v6.2.7"]], "type": "integer", "required": True},
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_carrier_endpoint_bwl"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_carrier_endpoint_bwl"
        )
