...
DOCUMENTATION = """
---
module: fortios_extender_lte_carrier_by_mcc_mnc
short_description: Display FortiExtender modem carrier based on MCC and MNC in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify extender feature and lte_carrier_by_mcc_mnc category.
...
def filter_extender_lte_carrier_by_mcc_mnc_data(json):
    option_list = ["sn"]
...
def extender_lte_carrier_by_mcc_mnc(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["extender_lte_carrier_by_mcc_mnc"] = filtered_data
...
def fortios_extender(data, fos, check_mode):
    ...
    if data["extender_lte_carrier_by_mcc_mnc"]:
        resp = extender_lte_carrier_by_mcc_mnc(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("extender_lte_carrier_by_mcc_mnc")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["extender_lte_carrier_by_mcc_mnc"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "extender_lte_carrier_by_mcc_mnc"
        )
