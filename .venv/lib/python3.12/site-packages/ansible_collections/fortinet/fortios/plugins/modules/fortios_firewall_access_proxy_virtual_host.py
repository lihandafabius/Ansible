...
DOCUMENTATION = """
---
module: fortios_firewall_access_proxy_virtual_host
short_description: Configure Access Proxy virtual hosts in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify firewall feature and access_proxy_virtual_host category.
...
options:
    ...
    firewall_access_proxy_virtual_host:
        ...
        suboptions:
            ...
            replacemsg_group:
                description:
                    - Access-proxy-virtual-host replacement message override group. Source system.replacemsg-group.name.
                type: str
            ssl_certificate:
                description:
...
def firewall_access_proxy_virtual_host(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["firewall_access_proxy_virtual_host"] = filtered_data
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_access_proxy_virtual_host"]:
        resp = firewall_access_proxy_virtual_host(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("firewall_access_proxy_virtual_host")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_access_proxy_virtual_host"]["options"][attribute_name] = (
