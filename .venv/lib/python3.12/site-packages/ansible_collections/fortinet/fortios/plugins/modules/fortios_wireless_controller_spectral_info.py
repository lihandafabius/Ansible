...
DOCUMENTATION = """
---
module: fortios_wireless_controller_spectral_info
short_description: Wireless controller spectrum analysis in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify wireless_controller feature and spectral_info category.
...
def filter_wireless_controller_spectral_info_data(json):
    option_list = ["set_wtp_id"]
...
def wireless_controller_spectral_info(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["wireless_controller_spectral_info"] = filtered_data
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_spectral_info"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "wireless_controller_spectral_info"
        )
