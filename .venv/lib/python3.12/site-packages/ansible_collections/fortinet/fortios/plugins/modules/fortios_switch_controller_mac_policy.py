...
DOCUMENTATION = """
---
module: fortios_switch_controller_mac_policy
short_description: Configure MAC policy to be applied on the managed FortiSwitch devices through NAC device in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify switch_controller feature and mac_policy category.
...
options:
    ...
    switch_controller_mac_policy:
        ...
        suboptions:
            ...
            fortilink:
                description:
                    - FortiLink interface for which this MAC policy belongs to. Source system.interface.name.
                type: str
            name:
                description:
                    - MAC policy name.
...
def switch_controller_mac_policy(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("switch-controller", "mac-policy", filtered_data, vdom=vdom)
    ...
    data_copy = data.copy()
    data_copy["switch_controller_mac_policy"] = filtered_data
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    if data["switch_controller_mac_policy"]:
        resp = switch_controller_mac_policy(data, fos, check_mode)
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_mac_policy"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["switch_controller_mac_policy"]["options"][attribute_name][
                "required"
            ] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_controller_mac_policy"
        )
