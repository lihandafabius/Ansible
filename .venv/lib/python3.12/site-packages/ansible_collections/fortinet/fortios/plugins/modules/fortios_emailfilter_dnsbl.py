...
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify emailfilter feature and dnsbl category.
        ...
        suboptions:
            ...
            entries:
                ...
                suboptions:
                    ...
                    id:
                        description:
                            - DNSBL/ORBL entry ID. see <a href='#notes'>Notes</a>.
                        required: true
                        type: int
                    server:
                        description:
...
def filter_emailfilter_dnsbl_data(json):
    option_list = [
        "comment",
        "entries",
        "fabric_force_sync",
...
def emailfilter_dnsbl(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["emailfilter_dnsbl"] = filtered_data
...
def fortios_emailfilter(data, fos, check_mode):
    ...
    if data["emailfilter_dnsbl"]:
        resp = emailfilter_dnsbl(data, fos, check_mode)
    else:
        fos._module.fail_json(msg="missing task body: %s" % ("emailfilter_dnsbl"))
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["emailfilter_dnsbl"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
        if mkeyname and mkeyname == attribute_name:
            fields["emailfilter_dnsbl"]["options"][attribute_name]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "emailfilter_dnsbl"
        )
