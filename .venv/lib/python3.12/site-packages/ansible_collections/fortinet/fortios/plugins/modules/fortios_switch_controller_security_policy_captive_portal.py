...
def switch_controller_security_policy_captive_portal(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["switch_controller_security_policy_captive_portal"] = filtered_data
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_security_policy_captive_portal"]["options"][
            attribute_name
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_controller_security_policy_captive_portal"
        )
