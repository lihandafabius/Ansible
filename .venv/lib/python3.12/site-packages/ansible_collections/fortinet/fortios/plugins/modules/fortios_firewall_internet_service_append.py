...
DOCUMENTATION = """
---
module: fortios_firewall_internet_service_append
short_description: Configure additional port mappings for Internet Services in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify firewall feature and internet_service_append category.
...
def firewall_internet_service_append(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["firewall_internet_service_append"] = filtered_data
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_internet_service_append"]:
        resp = firewall_internet_service_append(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("firewall_internet_service_append")
        )
...
versioned_schema = {
    ...
    "children": {
        "addr_mode": {
            "v_range": [["v7.2.1", ""]],
            "type": "string",
            "options": [{"value": "ipv4"}, {"value": "ipv6"}, {"value": "both"}],
        },
        "match_port": {
            "v_range": [["v6.2.0", "v6.2.0"], ["v6.2.5", ""]],
            "type": "integer",
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_internet_service_append"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_internet_service_append"
        )
