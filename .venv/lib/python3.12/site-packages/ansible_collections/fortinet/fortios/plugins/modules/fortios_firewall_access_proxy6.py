...
def firewall_access_proxy6(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        current_data = fos.get(
            "firewall", "access-proxy6", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
...
versioned_schema = {
    ...
    "elements": "dict",
    "children": {
        "name": {"v_range": [["v7.0.1", "v7.6.7"]], "type": "string", "required": True},
        "vip": {"v_range": [["v7.0.1", "v7.6.7"]], "type": "string"},
        "auth_portal": {
