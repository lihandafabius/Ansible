        ...
        suboptions:
            ...
            member:
                ...
                suboptions:
                    name:
                        description:
                            - Service or service group name. Source firewall.service.custom.name firewall.service.group.name.
                        required: true
                        type: str
            name:
                description:
...
def firewall_service_group(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("firewall.service", "group", filtered_data, vdom=vdom)
        current_data = fos.get(
            "firewall.service", "group", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
    ...
    data_copy = data.copy()
    data_copy["firewall_service_group"] = filtered_data
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_service_group"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["firewall_service_group"]["options"][attribute_name][
                "required"
            ] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_service_group"
        )
