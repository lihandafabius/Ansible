...
def filter_system_geoip_override_data(json):
    option_list = ["country_id", "description", "ip_range", "ip6_range", "name"]
...
def system_geoip_override(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["system_geoip_override"] = filtered_data
...
def fortios_system(data, fos, check_mode):
    ...
    if data["system_geoip_override"]:
        resp = system_geoip_override(data, fos, check_mode)
    else:
        fos._module.fail_json(msg="missing task body: %s" % ("system_geoip_override"))
...
versioned_schema = {
    ...
    "children": {
        ...
        "country_id": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "ip_range": {
            "type": "list",
            "elements": "dict",
            "children": {
        ...
        "ip6_range": {
            ...
            "children": {
                ...
                "start_ip": {"v_range": [["v6.4.0", ""]], "type": "string"},
                "end_ip": {"v_range": [["v6.4.0", ""]], "type": "string"},
            },
            "v_range": [["v6.4.0", ""]],
        },
    },
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["system_geoip_override"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["system_geoip_override"]["options"][attribute_name][
                "required"
            ] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "system_geoip_override"
        )
