...
def wireless_controller_hotspot20_anqp_3gpp_cellular(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["wireless_controller_hotspot20_anqp_3gpp_cellular"] = filtered_data
...
def fortios_wireless_controller_hotspot20(data, fos, check_mode):
    ...
    if data["wireless_controller_hotspot20_anqp_3gpp_cellular"]:
        resp = wireless_controller_hotspot20_anqp_3gpp_cellular(data, fos, check_mode)
    else:
    ...
    "children": {
        ...
        "mcc_mnc_list": {
            ...
            "children": {
                ...
                "mcc": {"v_range": [["v6.0.0", ""]], "type": "string"},
                "mnc": {"v_range": [["v6.0.0", ""]], "type": "string"},
            },
            "v_range": [["v6.0.0", ""]],
        },
    },
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_hotspot20_anqp_3gpp_cellular"]["options"][
            attribute_name
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "wireless_controller_hotspot20_anqp_3gpp_cellular"
        )
