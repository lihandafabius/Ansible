...
def filter_vpn_ssl_web_host_check_software_data(json):
    option_list = ["check_item_list", "guid", "name", "os_type", "type", "version"]
...
def vpn_ssl_web_host_check_software(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["vpn_ssl_web_host_check_software"] = filtered_data
...
def fortios_vpn_ssl_web(data, fos, check_mode):
    ...
    if data["vpn_ssl_web_host_check_software"]:
        resp = vpn_ssl_web_host_check_software(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("vpn_ssl_web_host_check_software")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["vpn_ssl_web_host_check_software"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "vpn_ssl_web_host_check_software"
        )
