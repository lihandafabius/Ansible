...
short_description: Configure web proxy address in Fortinet's FortiOS and FortiGate.
description:
...
def firewall_proxy_address(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("firewall", "proxy-address", filtered_data, vdom=vdom)
        current_data = fos.get(
            "firewall", "proxy-address", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
    ...
    data_copy = data.copy()
    data_copy["firewall_proxy_address"] = filtered_data
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_proxy_address"]:
        resp = firewall_proxy_address(data, fos, check_mode)
    else:
        fos._module.fail_json(msg="missing task body: %s" % ("firewall_proxy_address"))
...
versioned_schema = {
    ...
    "children": {
        ...
        "host_regex": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "path": {"v_range": [["v6.0.0", ""]], "type": "string"},
        ...
        "method": {
            ...
            "options": [
                ...
                {"value": "options"},
                {"value": "delete"},
                {"value": "update", "v_range": [["v7.6.1", ""]]},
                {"value": "patch", "v_range": [["v7.6.1", ""]]},
                {"value": "other", "v_range": [["v7.6.1", ""]]},
            ],
        ...
        "ua": {
            ...
            "options": [
                ...
                {"value": "firefox"},
                {"value": "safari"},
                {"value": "ie", "v_range": [["v7.2.4", ""]]},
                {"value": "edge", "v_range": [["v7.2.4", ""]]},
                {"value": "other"},
            ],
            "multiple_values": True,
            "elements": "str",
        },
        "ua_min_ver": {"v_range": [["v7.2.4", ""]], "type": "string"},
        "ua_max_ver": {"v_range": [["v7.2.4", ""]], "type": "string"},
        "header_name": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "header": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "case_sensitivity": {
            "v_range": [["v6.0.0", ""]],
            "type": "string",
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_proxy_address"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["firewall_proxy_address"]["options"][attribute_name][
                "required"
            ] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_proxy_address"
        )
