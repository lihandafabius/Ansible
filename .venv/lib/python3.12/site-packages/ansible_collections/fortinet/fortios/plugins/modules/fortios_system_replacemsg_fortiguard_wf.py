...
def system_replacemsg_fortiguard_wf(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["system_replacemsg_fortiguard_wf"] = filtered_data
...
def fortios_system_replacemsg(data, fos, check_mode):
    ...
    if data["system_replacemsg_fortiguard_wf"]:
        ...
        fos._module.fail_json(
            msg="missing task body: %s" % ("system_replacemsg_fortiguard_wf")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["system_replacemsg_fortiguard_wf"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "system_replacemsg_fortiguard_wf"
        )
