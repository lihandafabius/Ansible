...
DOCUMENTATION = """
---
module: fortios_firewall_internet_service_ipbl_vendor
short_description: IP block list vendor in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify firewall feature and internet_service_ipbl_vendor category.
...
options:
    ...
    firewall_internet_service_ipbl_vendor:
        ...
        suboptions:
            id:
                description:
                    - IP block list vendor ID. see <a href='#notes'>Notes</a>.
                required: true
                type: int
            name:
                description:
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_internet_service_ipbl_vendor"]:
        ...
        fos._module.fail_json(
            msg="missing task body: %s" % ("firewall_internet_service_ipbl_vendor")
        )
...
def main():
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_internet_service_ipbl_vendor"
        )
