...
options:
    ...
    switch_controller_switch_group:
        ...
        suboptions:
            ...
            fortilink:
                description:
                    - FortiLink interface to which switch group members belong. Source system.interface.name.
                type: str
            members:
                description:
...
def filter_switch_controller_switch_group_data(json):
    option_list = ["description", "fortilink", "members", "name"]
...
def switch_controller_switch_group(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["switch_controller_switch_group"] = filtered_data
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    if data["switch_controller_switch_group"]:
        resp = switch_controller_switch_group(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("switch_controller_switch_group")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_switch_group"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_controller_switch_group"
        )
