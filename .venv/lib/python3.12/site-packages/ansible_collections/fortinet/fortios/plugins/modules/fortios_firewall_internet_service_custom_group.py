...
- name: Configure custom Internet Service group.
  fortinet.fortios.fortios_firewall_internet_service_custom_group:
      ...
      firewall_internet_service_custom_group:
          ...
          member:
              -
                  name: "default_name_8 (source firewall.internet-service-custom.name)"
          name: "default_name_9"
          uuid: "<your_own_value>"
"""
...
def firewall_internet_service_custom_group(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey(
            "firewall", "internet-service-custom-group", filtered_data, vdom=vdom
        )
    ...
    data_copy = data.copy()
    data_copy["firewall_internet_service_custom_group"] = filtered_data
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_internet_service_custom_group"]:
        ...
        fos._module.fail_json(
            msg="missing task body: %s" % ("firewall_internet_service_custom_group")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_internet_service_custom_group"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_internet_service_custom_group"
        )
