...
def firewall_local_in_policy6(data, fos, check_mode=False):
    ...
    if firewall_local_in_policy6_data.get("intf_dict") is not None:
    ...
    if check_mode:
        ...
        current_data = fos.get(
            "firewall", "local-in-policy6", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
    ...
    data_copy = data.copy()
    data_copy["firewall_local_in_policy6"] = filtered_data
