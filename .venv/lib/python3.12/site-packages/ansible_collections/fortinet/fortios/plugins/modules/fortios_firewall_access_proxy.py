...
def firewall_access_proxy(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("firewall", "access-proxy", filtered_data, vdom=vdom)
        current_data = fos.get(
            "firewall", "access-proxy", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
    ...
    data_copy = data.copy()
    data_copy["firewall_access_proxy"] = filtered_data
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_access_proxy"]:
        resp = firewall_access_proxy(data, fos, check_mode)
    else:
    ...
    "children": {
            ...
            "children": {
                ...
                "ldb_method": {
                    ...
                    "options": [
                        ...
                        {"value": "first-alive"},
                        {"value": "http-host"},
                        {"value": "least-session", "v_range": [["v7.0.0", "v7.0.0"]]},
                ...
                "ssl_algorithm": {
                    ...
                    "options": [
                        ...
                        {"value": "medium"},
                        {"value": "low"},
                        {"value": "custom", "v_range": [["v7.0.0", "v7.0.0"]]},
                    ],
                },
                "ssl_cipher_suites": {
                    "type": "list",
                ...
                "cert_extension": {
                    ...
                    "children": {
                        ...
                        "type": {
                            "v_range": [["v7.0.0", "v7.0.0"]],
                            "type": "string",
                            "options": [{"value": "fixed"}, {"value": "user"}],
                        },
                        "data": {"v_range": [["v7.0.0", "v7.0.0"]], "type": "string"},
                    },
                    "v_range": [["v7.0.0", "v7.0.0"]],
                },
                "auth_ca": {"v_range": [["v7.0.0", "v7.0.0"]], "type": "string"},
            },
        },
        "ldb_method": {
            "v_range": [["v7.0.0", "v7.0.0"]],
        ...
        "realservers": {
            ...
            "children": {
                ...
                "ip": {"v_range": [["v7.0.0", "v7.0.0"]], "type": "string"},
                "port": {"v_range": [["v7.0.0", "v7.0.0"]], "type": "integer"},
                "status": {
                    "v_range": [["v7.0.0", "v7.0.0"]],
                    "type": "string",
                    "options": [
                ...
                "weight": {"v_range": [["v7.0.0", "v7.0.0"]], "type": "integer"},
            },
            "v_range": [["v7.0.0", "v7.0.0"]],
        },
    },
