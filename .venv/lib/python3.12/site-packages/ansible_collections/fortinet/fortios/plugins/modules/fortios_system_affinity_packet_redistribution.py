...
options:
    ...
    system_affinity_packet_redistribution:
        ...
        suboptions:
            ...
            id:
                description:
                    - ID of the packet redistribution setting. see <a href='#notes'>Notes</a>.
                required: true
                type: int
            interface:
                description:
...
def system_affinity_packet_redistribution(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["system_affinity_packet_redistribution"] = filtered_data
...
def fortios_system(data, fos, check_mode):
    ...
    if data["system_affinity_packet_redistribution"]:
        resp = system_affinity_packet_redistribution(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("system_affinity_packet_redistribution")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["system_affinity_packet_redistribution"]["options"][attribute_name] = (
