...
DOCUMENTATION = """
---
module: fortios_switch_controller_snmp_sysinfo
short_description: Configure FortiSwitch SNMP system information globally in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify switch_controller feature and snmp_sysinfo category.
...
def filter_switch_controller_snmp_sysinfo_data(json):
    option_list = ["contact_info", "description", "engine_id", "location", "status"]
...
def switch_controller_snmp_sysinfo(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["switch_controller_snmp_sysinfo"] = filtered_data
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    if data["switch_controller_snmp_sysinfo"]:
        resp = switch_controller_snmp_sysinfo(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("switch_controller_snmp_sysinfo")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_snmp_sysinfo"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_controller_snmp_sysinfo"
        )
