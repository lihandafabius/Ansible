...
DOCUMENTATION = """
---
module: fortios_extender_modem_status
short_description: Display detailed FortiExtender modem status in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify extender feature and modem_status category.
...
"""
EXAMPLES = """
- name: Display detailed FortiExtender modem status.
...
def extender_modem_status(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["extender_modem_status"] = filtered_data
...
def fortios_extender(data, fos, check_mode):
    ...
    if data["extender_modem_status"]:
        resp = extender_modem_status(data, fos, check_mode)
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["extender_modem_status"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["extender_modem_status"]["options"][attribute_name][
                "required"
            ] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "extender_modem_status"
        )
