...
versioned_schema = {
    ...
    "children": {
        ...
        "devindex": {"v_range": [["v6.0.0", ""]], "type": "integer"},
        ...
        "vrf": {"v_range": [["v7.0.1", ""]], "type": "integer"},
        "bfd": {
            "v_range": [["v6.0.0", ""]],
            "type": "string",
            "options": [{"value": "enable"}, {"value": "disable"}],
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["router_static6"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "router_static6"
        )
