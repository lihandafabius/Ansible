...
def switch_controller_qos_qos_policy(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["switch_controller_qos_qos_policy"] = filtered_data
...
def fortios_switch_controller_qos(data, fos, check_mode):
    ...
    if data["switch_controller_qos_qos_policy"]:
        resp = switch_controller_qos_qos_policy(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("switch_controller_qos_qos_policy")
        )
...
versioned_schema = {
    ...
    "children": {
        ...
        "default_cos": {"v_range": [["v6.0.0", ""]], "type": "integer"},
        "trust_dot1p_map": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "trust_ip_dscp_map": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "queue_policy": {"v_range": [["v6.0.0", ""]], "type": "string"},
    },
    "v_range": [["v6.0.0", ""]],
}
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_qos_qos_policy"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_controller_qos_qos_policy"
        )
