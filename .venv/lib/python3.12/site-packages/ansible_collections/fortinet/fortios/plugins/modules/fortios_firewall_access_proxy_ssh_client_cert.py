...
def firewall_access_proxy_ssh_client_cert(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["firewall_access_proxy_ssh_client_cert"] = filtered_data
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_access_proxy_ssh_client_cert"]:
        resp = firewall_access_proxy_ssh_client_cert(data, fos, check_mode)
    else:
    ...
    "children": {
        ...
        "cert_extension": {
            ...
            "children": {
                ...
                "data": {"v_range": [["v7.0.1", ""]], "type": "string"},
            },
            "v_range": [["v7.0.1", ""]],
        },
        "auth_ca": {"v_range": [["v7.0.1", ""]], "type": "string"},
    },
    "v_range": [["v7.0.1", ""]],
}
