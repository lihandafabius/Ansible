        ...
        suboptions:
            ...
            interface:
                ...
                suboptions:
                    name:
                        description:
                            - Decrypted traffic mirror interface. Source system.interface.name.
                        required: true
                        type: str
            name:
                description:
...
def firewall_decrypted_traffic_mirror(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["firewall_decrypted_traffic_mirror"] = filtered_data
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_decrypted_traffic_mirror"]:
        resp = firewall_decrypted_traffic_mirror(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("firewall_decrypted_traffic_mirror")
        )
...
versioned_schema = {
    ...
    "children": {
        ...
        "dstmac": {"v_range": [["v6.4.0", ""]], "type": "string"},
        "traffic_type": {
            "v_range": [["v6.4.0", ""]],
            "type": "list",
            "options": [{"value": "ssl"}, {"value": "ssh"}],
        ...
        "traffic_source": {
            "v_range": [["v6.4.0", ""]],
            "type": "string",
            "options": [{"value": "client"}, {"value": "server"}, {"value": "both"}],
        },
        "interface": {
            "type": "list",
            "elements": "dict",
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_decrypted_traffic_mirror"]["options"][attribute_name] = (
