...
def wireless_controller_hotspot20_anqp_ip_address_type(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["wireless_controller_hotspot20_anqp_ip_address_type"] = filtered_data
...
def fortios_wireless_controller_hotspot20(data, fos, check_mode):
    ...
    if data["wireless_controller_hotspot20_anqp_ip_address_type"]:
        resp = wireless_controller_hotspot20_anqp_ip_address_type(data, fos, check_mode)
    else:
    ...
    "children": {
        ...
        "ipv4_address_type": {
            ...
            "options": [
                {"value": "not-available"},
                {"value": "public"},
                {"value": "port-restricted"},
                {"value": "single-NATed-private"},
                {"value": "double-NATed-private"},
                {"value": "port-restricted-and-single-NATed"},
                {"value": "port-restricted-and-double-NATed"},
                {"value": "not-known"},
            ],
        },
    },
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_hotspot20_anqp_ip_address_type"]["options"][
            attribute_name
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "wireless_controller_hotspot20_anqp_ip_address_type"
        )
