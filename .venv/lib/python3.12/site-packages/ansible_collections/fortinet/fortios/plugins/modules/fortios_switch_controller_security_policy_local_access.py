...
DOCUMENTATION = """
---
module: fortios_switch_controller_security_policy_local_access
short_description: Configure allowaccess list for mgmt and internal interfaces on managed FortiSwitch units in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify switch_controller_security_policy feature and local_access category.
...
def filter_switch_controller_security_policy_local_access_data(json):
    option_list = ["internal_allowaccess", "mgmt_allowaccess", "name"]
...
def switch_controller_security_policy_local_access(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["switch_controller_security_policy_local_access"] = filtered_data
...
def fortios_switch_controller_security_policy(data, fos, check_mode):
    ...
    if data["switch_controller_security_policy_local_access"]:
        resp = switch_controller_security_policy_local_access(data, fos, check_mode)
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_security_policy_local_access"]["options"][
            attribute_name
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_controller_security_policy_local_access"
        )
