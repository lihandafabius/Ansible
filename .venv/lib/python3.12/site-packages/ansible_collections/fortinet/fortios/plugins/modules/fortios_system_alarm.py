...
def system_alarm(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("system", "alarm", filtered_data, vdom=vdom)
        current_data = fos.get(
            "system", "alarm", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
    ...
    data_copy = data.copy()
    data_copy["system_alarm"] = filtered_data
    ...
    return fos.set(
        "system", "alarm", data=converted_data, vdom=vdom, parameters=parameters
    )
    ...
    "children": {
        ...
        "groups": {
            ...
            "children": {
                ...
                "period": {"v_range": [["v6.0.0", ""]], "type": "integer"},
                "admin_auth_failure_threshold": {
                    "v_range": [["v6.0.0", ""]],
                    "type": "integer",
                },
                ...
                "fw_policy_id": {"v_range": [["v6.0.0", ""]], "type": "integer"},
                "fw_policy_id_threshold": {
                    "v_range": [["v6.0.0", ""]],
                    "type": "integer",
                },
