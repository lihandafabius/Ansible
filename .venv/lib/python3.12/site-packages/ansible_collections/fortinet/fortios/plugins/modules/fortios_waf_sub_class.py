...
options:
    ...
    waf_sub_class:
        ...
        suboptions:
            id:
                description:
                    - Signature subclass ID. see <a href='#notes'>Notes</a>.
                required: true
                type: int
            name:
                description:
...
def waf_sub_class(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["waf_sub_class"] = filtered_data
...
def fortios_waf(data, fos, check_mode):
    ...
    if data["waf_sub_class"]:
        ...
        fos._module.fail_json(msg="missing task body: %s" % ("waf_sub_class"))
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["waf_sub_class"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
        if mkeyname and mkeyname == attribute_name:
            fields["waf_sub_class"]["options"][attribute_name]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "waf_sub_class"
        )
