...
DOCUMENTATION = """
---
module: fortios_wireless_controller_access_control_list
short_description: Configure WiFi bridge access control list in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify wireless_controller feature and access_control_list category.
        ...
        suboptions:
            ...
            layer3_ipv4_rules:
                ...
                suboptions:
                    ...
                    dstaddr:
                        description:
                            - Destination IP address (any | local-LAN | IPv4 address[/<network mask | mask length>]).
                        type: str
                    dstport:
                        description:
...
def filter_wireless_controller_access_control_list_data(json):
    option_list = ["comment", "layer3_ipv4_rules", "layer3_ipv6_rules", "name"]
...
def wireless_controller_access_control_list(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey(
            "wireless-controller", "access-control-list", filtered_data, vdom=vdom
        )
    ...
    data_copy = data.copy()
    data_copy["wireless_controller_access_control_list"] = filtered_data
...
def fortios_wireless_controller(data, fos, check_mode):
    ...
    if data["wireless_controller_access_control_list"]:
        resp = wireless_controller_access_control_list(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("wireless_controller_access_control_list")
        )
    ...
    "children": {
        ...
        "layer3_ipv4_rules": {
            ...
            "children": {
                ...
                "comment": {"v_range": [["v6.4.0", ""]], "type": "string"},
                "srcaddr": {"v_range": [["v6.4.0", ""]], "type": "string"},
                "srcport": {"v_range": [["v6.4.0", ""]], "type": "integer"},
                "dstaddr": {"v_range": [["v6.4.0", ""]], "type": "string"},
                "dstport": {"v_range": [["v6.4.0", ""]], "type": "integer"},
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_access_control_list"]["options"][attribute_name] = (
            module_spec["options"][attribute_name]
        )
        if mkeyname and mkeyname == attribute_name:
            fields["wireless_controller_access_control_list"]["options"][
                attribute_name
            ]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "wireless_controller_access_control_list"
        )
