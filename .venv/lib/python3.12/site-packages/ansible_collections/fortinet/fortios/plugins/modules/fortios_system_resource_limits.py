...
def system_resource_limits(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("system", "resource-limits", filtered_data, vdom=vdom)
        current_data = fos.get(
            "system", "resource-limits", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
    ...
    data_copy = data.copy()
    data_copy["system_resource_limits"] = filtered_data
