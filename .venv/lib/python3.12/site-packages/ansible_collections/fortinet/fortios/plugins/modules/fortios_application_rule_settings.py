...
def application_rule_settings(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["application_rule_settings"] = filtered_data
...
def fortios_application(data, fos, check_mode):
    ...
    if data["application_rule_settings"]:
        resp = application_rule_settings(data, fos, check_mode)
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["application_rule_settings"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["application_rule_settings"]["options"][attribute_name][
                "required"
            ] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "application_rule_settings"
        )
