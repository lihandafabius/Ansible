...
DOCUMENTATION = """
---
module: fortios_extension_controller_dataplan
short_description: FortiExtender dataplan configuration in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify extension_controller feature and dataplan category.
...
def extension_controller_dataplan(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["extension_controller_dataplan"] = filtered_data
...
def fortios_extension_controller(data, fos, check_mode):
    ...
    if data["extension_controller_dataplan"]:
        resp = extension_controller_dataplan(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("extension_controller_dataplan")
        )
...
versioned_schema = {
    ...
    "children": {
        ...
        "iccid": {"v_range": [["v7.2.1", ""]], "type": "string"},
        "carrier": {"v_range": [["v7.2.1", ""]], "type": "string"},
        "apn": {"v_range": [["v7.2.1", ""]], "type": "string"},
        "auth_type": {
            "v_range": [["v7.2.1", ""]],
            "type": "string",
            "options": [{"value": "none"}, {"value": "pap"}, {"value": "chap"}],
        },
        "username": {"v_range": [["v7.2.1", ""]], "type": "string"},
        "password": {"v_range": [["v7.2.1", ""]], "type": "string"},
        "pdn": {
            "v_range": [["v7.2.1", ""]],
            "type": "string",
            "options": [
        ...
        "signal_threshold": {"v_range": [["v7.2.1", ""]], "type": "integer"},
        "signal_period": {"v_range": [["v7.2.1", ""]], "type": "integer"},
        "capacity": {"v_range": [["v7.2.1", ""]], "type": "integer"},
        "monthly_fee": {"v_range": [["v7.2.1", ""]], "type": "integer"},
        "billing_date": {"v_range": [["v7.2.1", ""]], "type": "integer"},
        "overage": {
            "v_range": [["v7.2.1", ""]],
            "type": "string",
            "options": [{"value": "disable"}, {"value": "enable"}],
        },
        "preferred_subnet": {"v_range": [["v7.2.1", ""]], "type": "integer"},
        "private_network": {
            "v_range": [["v7.2.1", ""]],
            "type": "string",
            "options": [{"value": "disable"}, {"value": "enable"}],
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["extension_controller_dataplan"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "extension_controller_dataplan"
        )
