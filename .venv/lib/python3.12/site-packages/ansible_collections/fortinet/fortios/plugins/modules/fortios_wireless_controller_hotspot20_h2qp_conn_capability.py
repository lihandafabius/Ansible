...
def wireless_controller_hotspot20_h2qp_conn_capability(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["wireless_controller_hotspot20_h2qp_conn_capability"] = filtered_data
...
def fortios_wireless_controller_hotspot20(data, fos, check_mode):
    ...
    if data["wireless_controller_hotspot20_h2qp_conn_capability"]:
        resp = wireless_controller_hotspot20_h2qp_conn_capability(data, fos, check_mode)
    else:
...
versioned_schema = {
    ...
    "children": {
        ...
        "icmp_port": {
            "v_range": [["v6.0.0", ""]],
            "type": "string",
            "options": [{"value": "closed"}, {"value": "open"}, {"value": "unknown"}],
        },
        "ftp_port": {
            "v_range": [["v6.0.0", ""]],
            "type": "string",
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_hotspot20_h2qp_conn_capability"]["options"][
            attribute_name
