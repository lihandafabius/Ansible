...
def endpoint_control_fctems(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        current_data = fos.get(
            "endpoint-control", "fctems", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
...
versioned_schema = {
    ...
    "children": {
        ...
        "serial_number": {
            "v_range": [["v6.2.0", "v6.2.7"], ["v7.0.8", "v7.0.12"], ["v7.2.1", ""]],
            "type": "string",
        },
        "tenant_id": {"v_range": [["v7.2.1", ""]], "type": "string"},
        ...
        "capabilities": {
            ...
            "options": [
                ...
                {"value": "websocket"},
                {"value": "websocket-malware", "v_range": [["v7.0.1", ""]]},
                {"value": "push-ca-certs", "v_range": [["v7.0.1", ""]]},
                {"value": "common-tags-api", "v_range": [["v7.0.4", ""]]},
        ...
        "status_check_interval": {"v_range": [["v6.4.4", "v6.4.4"]], "type": "integer"},
        "certificate": {"v_range": [["v6.4.0", "v6.4.4"]], "type": "string"},
        "admin_username": {"v_range": [["v6.2.0", "v6.2.7"]], "type": "string"},
        "admin_password": {"v_range": [["v6.2.0", "v6.2.7"]], "type": "string"},
    },
    "v_range": [["v6.2.0", ""]],
}
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["endpoint_control_fctems"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["endpoint_control_fctems"]["options"][attribute_name][
                "required"
            ] = True
