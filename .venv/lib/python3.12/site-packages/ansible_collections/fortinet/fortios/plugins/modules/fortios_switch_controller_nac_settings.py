...
def switch_controller_nac_settings(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["switch_controller_nac_settings"] = filtered_data
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_nac_settings"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_controller_nac_settings"
        )
