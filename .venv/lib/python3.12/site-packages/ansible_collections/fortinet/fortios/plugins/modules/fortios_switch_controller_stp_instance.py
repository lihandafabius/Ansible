...
DOCUMENTATION = """
---
module: fortios_switch_controller_stp_instance
short_description: Configure FortiSwitch multiple spanning tree protocol (MSTP) instances in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify switch_controller feature and stp_instance category.
...
def filter_switch_controller_stp_instance_data(json):
    option_list = ["id", "vlan_range"]
...
def switch_controller_stp_instance(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["switch_controller_stp_instance"] = filtered_data
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    if data["switch_controller_stp_instance"]:
        resp = switch_controller_stp_instance(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("switch_controller_stp_instance")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_stp_instance"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_controller_stp_instance"
        )
