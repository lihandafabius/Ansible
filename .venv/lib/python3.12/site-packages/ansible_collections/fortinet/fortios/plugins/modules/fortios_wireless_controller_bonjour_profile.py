...
def wireless_controller_bonjour_profile(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["wireless_controller_bonjour_profile"] = filtered_data
...
def fortios_wireless_controller(data, fos, check_mode):
    ...
    if data["wireless_controller_bonjour_profile"]:
        ...
        fos._module.fail_json(
            msg="missing task body: %s" % ("wireless_controller_bonjour_profile")
        )
    ...
    "children": {
        ...
        "policy_list": {
            ...
            "children": {
                ...
                "from_vlan": {"v_range": [["v6.0.0", ""]], "type": "string"},
                "to_vlan": {"v_range": [["v6.0.0", ""]], "type": "string"},
                "services": {
                    "v_range": [["v6.0.0", ""]],
                    "type": "list",
                    "options": [
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_bonjour_profile"]["options"][attribute_name] = (
