...
def user_fortitoken(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["user_fortitoken"] = filtered_data
...
def fortios_user(data, fos, check_mode):
    ...
    if data["user_fortitoken"]:
        resp = user_fortitoken(data, fos, check_mode)
    else:
...
versioned_schema = {
    ...
    "children": {
        ...
        "status": {
            "v_range": [["v6.0.0", ""]],
            "type": "string",
            "options": [{"value": "active"}, {"value": "lock"}],
        },
        "seed": {
            "v_range": [
                ["v6.0.0", "v6.0.11"],
        ...
        "license": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "activation_code": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "activation_expire": {"v_range": [["v6.0.0", ""]], "type": "integer"},
        "reg_id": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "os_ver": {"v_range": [["v6.0.0", ""]], "type": "string"},
    },
    "v_range": [["v6.0.0", ""]],
}
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["user_fortitoken"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
        if mkeyname and mkeyname == attribute_name:
            fields["user_fortitoken"]["options"][attribute_name]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "user_fortitoken"
        )
