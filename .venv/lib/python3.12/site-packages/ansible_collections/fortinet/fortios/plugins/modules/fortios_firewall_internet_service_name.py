...
DOCUMENTATION = """
---
module: fortios_firewall_internet_service_name
short_description: Define internet service names in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify firewall feature and internet_service_name category.
...
options:
    ...
    firewall_internet_service_name:
        ...
        suboptions:
            city_id:
                description:
                    - City ID. Source firewall.city.id.
                type: int
            country_id:
                description:
            ...
            region_id:
                description:
                    - Region ID. Source firewall.region.id.
                type: int
            type:
                description:
...
def filter_firewall_internet_service_name_data(json):
    option_list = [
        "city_id",
        "country_id",
        "fabric_force_sync",
...
def firewall_internet_service_name(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["firewall_internet_service_name"] = filtered_data
...
def fortios_firewall(data, fos, check_mode):
    ...
    if data["firewall_internet_service_name"]:
        ...
        fos._module.fail_json(
            msg="missing task body: %s" % ("firewall_internet_service_name")
        )
...
versioned_schema = {
    ...
    "children": {
        ...
        "type": {
            "v_range": [["v6.4.0", ""]],
            "type": "string",
            "options": [{"value": "default"}, {"value": "location"}],
        },
        "internet_service_id": {"v_range": [["v6.4.0", ""]], "type": "integer"},
        "country_id": {"v_range": [["v6.4.0", ""]], "type": "integer"},
        "region_id": {"v_range": [["v6.4.0", ""]], "type": "integer"},
        "city_id": {"v_range": [["v6.4.0", ""]], "type": "integer"},
    },
    "v_range": [["v6.4.0", ""]],
}
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_internet_service_name"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_internet_service_name"
        )
