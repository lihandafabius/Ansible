...
options:
    ...
    firewall_ttl_policy:
        ...
        suboptions:
            ...
            srcintf:
                description:
                    - Source interface name from available interfaces. Source system.zone.name system.sdwan.zone.name system.interface.name.
                type: str
            status:
                description:
...
def firewall_ttl_policy(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["firewall_ttl_policy"] = filtered_data
...
versioned_schema = {
    ...
    "children": {
        ...
        "ttl": {"v_range": [["v6.0.0", ""]], "type": "string"},
    },
    "v_range": [["v6.0.0", ""]],
}
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_ttl_policy"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["firewall_ttl_policy"]["options"][attribute_name]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_ttl_policy"
        )
