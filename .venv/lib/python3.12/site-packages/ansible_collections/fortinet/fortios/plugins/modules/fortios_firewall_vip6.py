...
- name: Configure virtual IP for IPv6.
  fortinet.fortios.fortios_firewall_vip6:
      ...
      firewall_vip6:
          ...
          monitor:
              -
                  name: "default_name_34 (source firewall.ldb-monitor.name)"
          ...
          realservers:
              -
                  ...
                  monitor:
                      -
                          name: "default_name_62 (source firewall.ldb-monitor.name)"
                  port: "0"
                  status: "active"
          ...
          ssl_certificate_dict:
              -
                  name: "default_name_76 (source vpn.certificate.local.name)"
          ssl_cipher_suites:
              -
    ...
    "children": {
        ...
        "type": {
            ...
            "options": [
                ...
                {"value": "access-proxy", "v_range": [["v7.0.1", ""]]},
            ],
        },
        "src_filter": {
            "type": "list",
        ...
        "mappedip": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "nat_source_vip": {
            "v_range": [["v6.4.0", ""]],
            "type": "string",
            "options": [{"value": "disable"}, {"value": "enable"}],
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_vip6"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_vip6"
        )
