...
def ips_custom(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["ips_custom"] = filtered_data
...
def fortios_ips(data, fos, check_mode):
    ...
    if data["ips_custom"]:
        resp = ips_custom(data, fos, check_mode)
    else:
...
versioned_schema = {
    ...
    "children": {
        ...
        "severity": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "location": {
            "v_range": [["v6.0.0", ""]],
            "type": "list",
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["ips_custom"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
        if mkeyname and mkeyname == attribute_name:
            fields["ips_custom"]["options"][attribute_name]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "ips_custom"
        )
