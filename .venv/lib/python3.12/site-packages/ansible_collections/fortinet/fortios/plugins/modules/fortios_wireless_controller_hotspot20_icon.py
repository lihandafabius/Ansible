...
def wireless_controller_hotspot20_icon(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey(
            "wireless-controller.hotspot20", "icon", filtered_data, vdom=vdom
        )
    ...
    data_copy = data.copy()
    data_copy["wireless_controller_hotspot20_icon"] = filtered_data
...
def fortios_wireless_controller_hotspot20(data, fos, check_mode):
    ...
    if data["wireless_controller_hotspot20_icon"]:
        resp = wireless_controller_hotspot20_icon(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("wireless_controller_hotspot20_icon")
        )
    ...
    "children": {
        ...
        "icon_list": {
            ...
            "children": {
                ...
                "lang": {"v_range": [["v6.0.0", ""]], "type": "string"},
                "file": {"v_range": [["v6.0.0", ""]], "type": "string"},
                "type": {
                    "v_range": [["v6.0.0", ""]],
                    "type": "string",
                    "options": [
                ...
                "width": {"v_range": [["v6.0.0", ""]], "type": "integer"},
                "height": {"v_range": [["v6.0.0", ""]], "type": "integer"},
            },
            "v_range": [["v6.0.0", ""]],
        },
    },
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_hotspot20_icon"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "wireless_controller_hotspot20_icon"
        )
