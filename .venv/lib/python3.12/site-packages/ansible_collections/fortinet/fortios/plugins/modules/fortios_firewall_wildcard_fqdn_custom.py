...
def firewall_wildcard_fqdn_custom(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey(
            "firewall.wildcard-fqdn", "custom", filtered_data, vdom=vdom
        )
    ...
    data_copy = data.copy()
    data_copy["firewall_wildcard_fqdn_custom"] = filtered_data
...
def fortios_firewall_wildcard_fqdn(data, fos, check_mode):
    ...
    if data["firewall_wildcard_fqdn_custom"]:
        ...
        fos._module.fail_json(
            msg="missing task body: %s" % ("firewall_wildcard_fqdn_custom")
        )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_wildcard_fqdn_custom"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "firewall_wildcard_fqdn_custom"
        )
