...
def filter_wireless_controller_apcfg_profile_data(json):
    option_list = [
        "ac_ip",
        "ac_port",
        "ac_timer",
...
def wireless_controller_apcfg_profile(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey(
            "wireless-controller", "apcfg-profile", filtered_data, vdom=vdom
        )
    ...
    data_copy = data.copy()
    data_copy["wireless_controller_apcfg_profile"] = filtered_data
...
def fortios_wireless_controller(data, fos, check_mode):
    ...
    if data["wireless_controller_apcfg_profile"]:
        resp = wireless_controller_apcfg_profile(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("wireless_controller_apcfg_profile")
        )
...
versioned_schema = {
    ...
    "children": {
        ...
        "ap_family": {
            "v_range": [["v7.0.2", ""]],
            "type": "string",
            "options": [{"value": "fap"}, {"value": "fap-u"}, {"value": "fap-c"}],
        },
        "comment": {"v_range": [["v6.4.0", ""]], "type": "string"},
        "ac_type": {
            "v_range": [["v6.4.0", ""]],
            "type": "string",
            "options": [{"value": "default"}, {"value": "specify"}, {"value": "apcfg"}],
        },
        "ac_timer": {"v_range": [["v6.4.0", ""]], "type": "integer"},
        "ac_ip": {"v_range": [["v6.4.0", ""]], "type": "string"},
        "ac_port": {"v_range": [["v6.4.0", ""]], "type": "integer"},
        "command_list": {
            "type": "list",
            "elements": "dict",
            "children": {
                ...
                "type": {
                    "v_range": [["v6.4.0", ""]],
                    "type": "string",
                    "options": [{"value": "non-password"}, {"value": "password"}],
                },
                "name": {"v_range": [["v6.4.0", ""]], "type": "string"},
                "value": {"v_range": [["v6.4.0", ""]], "type": "string"},
                "passwd_value": {"v_range": [["v6.4.0", ""]], "type": "string"},
            },
            "v_range": [["v6.4.0", ""]],
        },
    },
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_apcfg_profile"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "wireless_controller_apcfg_profile"
        )
