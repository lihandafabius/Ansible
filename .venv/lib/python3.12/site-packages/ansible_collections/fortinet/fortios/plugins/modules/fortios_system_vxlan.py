...
def system_vxlan(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("system", "vxlan", filtered_data, vdom=vdom)
        current_data = fos.get(
            "system", "vxlan", vdom=vdom, mkey=mkey, parameters=parameters
        )
        is_existed = (
            current_data
    ...
    data_copy = data.copy()
    data_copy["system_vxlan"] = filtered_data
    ...
    if state == "present" or state is True:
        return fos.set(
            "system", "vxlan", data=converted_data, vdom=vdom, parameters=parameters
        )
...
versioned_schema = {
    ...
    "children": {
        ...
        "remote_ip6": {
            ...
            "elements": "dict",
            "children": {
                "ip6": {"v_range": [["v6.0.0", ""]], "type": "string", "required": True}
            },
            "v_range": [["v6.0.0", ""]],
        },
