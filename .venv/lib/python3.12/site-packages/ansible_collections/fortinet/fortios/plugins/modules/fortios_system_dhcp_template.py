...
DOCUMENTATION = """
---
module: fortios_system_dhcp_template
short_description: Configure DHCP server templates in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify system_dhcp feature and template category.
...
def filter_system_dhcp_template_data(json):
    option_list = [
        "auto_configuration",
        "conflicted_ip_timeout",
        "ddns_auth",
...
def system_dhcp_template(data, fos):
    state = None
    vdom = data["vdom"]
    parameters = None
    state = data.get("state", None)
    system_dhcp_template_data = data["system_dhcp_template"]

    filtered_data = filter_system_dhcp_template_data(system_dhcp_template_data)
    ...
    data_copy = data.copy()
    data_copy["system_dhcp_template"] = filtered_data
...
def fortios_system_dhcp(data, fos):
    ...
    if data["system_dhcp_template"]:
        resp = system_dhcp_template(data, fos)
    else:
        fos._module.fail_json(msg="missing task body: %s" % ("system_dhcp_template"))
...
versioned_schema = {
    ...
    "children": {
        ...
        "lease_time": {"v_range": [["v8.0.0", ""]], "type": "integer"},
        "mac_acl_default_action": {
            "v_range": [["v8.0.0", ""]],
            "type": "string",
        ...
        "dns_server1": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "dns_server2": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "dns_server3": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "dns_server4": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "wifi_ac_service": {
            "v_range": [["v8.0.0", ""]],
            "type": "string",
            "options": [{"value": "specify"}, {"value": "local"}],
        },
        "wifi_ac1": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "wifi_ac2": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "wifi_ac3": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "ntp_service": {
            "v_range": [["v8.0.0", ""]],
            "type": "string",
            "options": [{"value": "local"}, {"value": "default"}, {"value": "specify"}],
        },
        "ntp_server1": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "ntp_server2": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "ntp_server3": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "domain": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "wins_server1": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "wins_server2": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "next_server": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "reserve_extra_addresses": {
            "v_range": [["v8.0.0", ""]],
            "type": "string",
            "options": [{"value": "disable"}, {"value": "enable"}],
        ...
        "ip_range": {
            ...
            "children": {
                ...
                "ip_count": {"v_range": [["v8.0.0", ""]], "type": "integer"},
                "reserve": {
                    "v_range": [["v8.0.0", ""]],
                    "type": "string",
                    "options": [{"value": "disable"}, {"value": "enable"}],
        ...
        "timezone": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "tftp_server": {
            "type": "list",
            "elements": "dict",
            "children": {
        ...
        "filename": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "options": {
            "type": "list",
            "elements": "dict",
            "children": {
                ...
                "code": {"v_range": [["v8.0.0", ""]], "type": "integer"},
                "type": {
                    "v_range": [["v8.0.0", ""]],
                    "type": "string",
                    "options": [
                ...
                "value": {"v_range": [["v8.0.0", ""]], "type": "string"},
                "ip": {
                    "v_range": [["v8.0.0", ""]],
                    "type": "list",
        ...
        "conflicted_ip_timeout": {"v_range": [["v8.0.0", ""]], "type": "integer"},
        "ipsec_lease_hold": {"v_range": [["v8.0.0", ""]], "type": "integer"},
        "auto_configuration": {
            "v_range": [["v8.0.0", ""]],
            "type": "string",
            "options": [{"value": "disable"}, {"value": "enable"}],
        ...
        "ddns_server_ip": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "ddns_zone": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "ddns_auth": {
            "v_range": [["v8.0.0", ""]],
            "type": "string",
            "options": [{"value": "disable"}, {"value": "tsig"}],
        },
        "ddns_keyname": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "ddns_key": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "ddns_ttl": {"v_range": [["v8.0.0", ""]], "type": "integer"},
        "vci_match": {
            "v_range": [["v8.0.0", ""]],
            "type": "string",
            "options": [{"value": "disable"}, {"value": "enable"}],
        ...
        "exclude_range": {
            ...
            "children": {
                ...
                "start_ip_index": {"v_range": [["v8.0.0", ""]], "type": "integer"},
                "ip_count": {"v_range": [["v8.0.0", ""]], "type": "integer"},
                "vci_match": {
                    "v_range": [["v8.0.0", ""]],
                    "type": "string",
        ...
        "relay_agent": {"v_range": [["v8.0.0", ""]], "type": "string"},
        "reserved_address": {
            "type": "list",
            "elements": "dict",
            "children": {
                ...
                "ip_index": {"v_range": [["v8.0.0", ""]], "type": "integer"},
                "mac": {"v_range": [["v8.0.0", ""]], "type": "string"},
                "action": {
                    "v_range": [["v8.0.0", ""]],
                    "type": "string",
                    "options": [
                ...
                "circuit_id": {"v_range": [["v8.0.0", ""]], "type": "string"},
                "remote_id_type": {
                    "v_range": [["v8.0.0", ""]],
                    "type": "string",
                    "options": [{"value": "hex"}, {"value": "string"}],
                },
                "remote_id": {"v_range": [["v8.0.0", ""]], "type": "string"},
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["system_dhcp_template"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["system_dhcp_template"]["options"][attribute_name]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "system_dhcp_template"
        )

        is_error, has_changed, result, diff = fortios_system_dhcp(module.params, fos)
