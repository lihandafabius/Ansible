...
DOCUMENTATION = """
---
module: fortios_videofilter_youtube_channel_filter
short_description: Configure YouTube channel filter in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify videofilter feature and youtube_channel_filter category.
...
options:
    ...
    videofilter_youtube_channel_filter:
        ...
        suboptions:
            ...
            default_action:
                description:
                    - YouTube channel filter default action.
                type: str
                choices:
                    - 'allow'
                    - 'monitor'
            ...
            override_category:
                description:
                    - Enable/disable overriding category filtering result.
                type: str
                choices:
                    - 'enable'
                    - 'disable'
...
def filter_videofilter_youtube_channel_filter_data(json):
    option_list = [
        "comment",
        "default_action",
        "entries",
...
def videofilter_youtube_channel_filter(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["videofilter_youtube_channel_filter"] = filtered_data
...
def fortios_videofilter(data, fos, check_mode):
    ...
    if data["videofilter_youtube_channel_filter"]:
        resp = videofilter_youtube_channel_filter(data, fos, check_mode)
    else:
        fos._module.fail_json(
            msg="missing task body: %s" % ("videofilter_youtube_channel_filter")
        )
...
versioned_schema = {
    ...
    "children": {
        ...
        "override_category": {
            "v_range": [["v7.0.6", "v7.0.12"], ["v7.2.1", "v7.2.4"]],
            "type": "string",
            "options": [{"value": "enable"}, {"value": "disable"}],
        },
    },
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["videofilter_youtube_channel_filter"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "videofilter_youtube_channel_filter"
        )
