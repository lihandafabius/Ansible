...
def system_api_user(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["system_api_user"] = filtered_data
...
versioned_schema = {
    ...
    "children": {
        ...
        "api_key": {"v_range": [["v6.0.0", ""]], "type": "string"},
        ...
        "cors_allow_origin": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "peer_auth": {
            "v_range": [["v6.0.0", ""]],
            "type": "string",
        ...
        "trusthost": {
            ...
            "children": {
                ...
                "ipv4_trusthost": {"v_range": [["v6.0.0", ""]], "type": "string"},
                "ipv6_trusthost": {"v_range": [["v6.0.0", ""]], "type": "string"},
            },
            "v_range": [["v6.0.0", ""]],
        },
    },
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["system_api_user"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
