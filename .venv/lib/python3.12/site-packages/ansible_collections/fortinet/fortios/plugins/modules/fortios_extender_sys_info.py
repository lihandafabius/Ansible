...
DOCUMENTATION = """
---
module: fortios_extender_sys_info
short_description: Display detailed FortiExtender system information in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify extender feature and sys_info category.
...
def filter_extender_sys_info_data(json):
    option_list = ["sn"]
...
def fortios_extender(data, fos, check_mode):
    ...
    if data["extender_sys_info"]:
        ...
        fos._module.fail_json(msg="missing task body: %s" % ("extender_sys_info"))
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["extender_sys_info"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
        if mkeyname and mkeyname == attribute_name:
            fields["extender_sys_info"]["options"][attribute_name]["required"] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "extender_sys_info"
        )
