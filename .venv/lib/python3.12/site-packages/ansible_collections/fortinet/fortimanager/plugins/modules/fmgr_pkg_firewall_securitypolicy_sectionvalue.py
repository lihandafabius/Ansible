...
def main():
    ...
    module_arg_spec = {
        ...
        'pkg_firewall_securitypolicy_sectionvalue': {
            'type': 'dict', 'v_range': [['6.4.0', '7.2.2'], ['7.2.4', '7.2.4'], ['7.2.6', '7.2.12'], ['7.4.2', '']],
            'options': {
                'attr': {
                    'v_range': [['6.4.0', '7.2.2'], ['7.2.4', '7.2.4'], ['7.2.6', '7.2.12'], ['7.4.2', '']],
                    'choices': ['label', 'global-label'],
                    'type': 'str'
                },
                'name': {'v_range': [['6.4.0', '7.2.2'], ['7.2.4', '7.2.4'], ['7.2.6', '7.2.12'], ['7.4.2', '']], 'type': 'str'}
            }
        }
    }
