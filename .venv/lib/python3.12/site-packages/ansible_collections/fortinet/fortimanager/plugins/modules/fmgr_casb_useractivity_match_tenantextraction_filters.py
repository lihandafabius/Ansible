...
DOCUMENTATION = '''
---
module: fmgr_casb_useractivity_match_tenantextraction_filters
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: CASB user activity tenant extraction filters.
      fortinet.fortimanager.fmgr_casb_useractivity_match_tenantextraction_filters:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'casb_useractivity_match_tenantextraction_filters'),
