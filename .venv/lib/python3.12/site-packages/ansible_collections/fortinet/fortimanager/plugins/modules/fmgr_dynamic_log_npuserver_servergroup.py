...
DOCUMENTATION = '''
---
module: fmgr_dynamic_log_npuserver_servergroup
short_description: Dynamic log npu server server group
...
- name: Example playbook (generated based on argument schema)
  ...
  gather_facts: false
  tasks:
    - name: Dynamic log npu server server group
      fortinet.fortimanager.fmgr_dynamic_log_npuserver_servergroup:
...
def main():
    ...
    module_arg_spec = {
        ...
        'dynamic_log_npuserver_servergroup': {
            ...
            'options': {
                'description': {'v_range': [['7.0.15', '7.0.16'], ['7.4.8', '7.4.11'], ['7.6.5', '']], 'type': 'str'},
                'dynamic_mapping': {
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dynamic_log_npuserver_servergroup'),
