    ...
    - name: Configure HTTP AntiVirus options.
      fortinet.fortimanager.fmgr_antivirus_profile_http:
        ...
        antivirus_profile_http:
          ...
          # options: ["scan", "file-filter", "quarantine", "avquery", "avmonitor", "strict-file"]
    ...
    module_arg_spec = {
        ...
        'antivirus_profile_http': {
            ...
            'options': {
                ...
                'unknown-content-encoding': {'v_range': [['7.0.5', '7.0.16'], ['7.2.1', '']], 'choices': ['block', 'inspect', 'bypass'], 'type': 'str'},
