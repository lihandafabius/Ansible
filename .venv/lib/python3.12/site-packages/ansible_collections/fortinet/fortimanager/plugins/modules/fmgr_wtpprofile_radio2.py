    ...
    suboptions:
      ...
      band:
        ...
        choices: ['802.11b', '802.11a', '802.11g', '802.11n', '802.11ac', '802.11n-5G',
                  ...
                  '802.11ax-5G-only', '802.11ax,ac-only', '802.11ax,ac,n-only', '802.11ax-only',
                  '802.11ax,n-only', '802.11ax,n,g-only', '802.11ac-2G', '802.11ax-6G',
    ...
    module_arg_spec = {
        ...
        'wtpprofile_radio2': {
            ...
            'options': {
                ...
                'spectrum-analysis': {'v_range': [['6.0.0', '7.6.7']], 'choices': ['disable', 'enable', 'scan-only'], 'type': 'str'},
