...
def main():
    ...
    module_arg_spec = {
        ...
        'switchcontroller_managedswitch_vlan': {
            'type': 'dict', 'v_range': [['7.4.2', '7.4.10'], ['7.6.0', '7.6.6']],
            'options': {
                'assignment-priority': {'v_range': [['7.4.2', '7.4.10'], ['7.6.0', '7.6.6']], 'type': 'int'},
                'vlan-name': {'v_range': [['7.4.2', '7.4.10'], ['7.6.0', '7.6.6']], 'type': 'str'}
            }
        }
    }
