...
DOCUMENTATION = '''
---
module: fmgr_firewall_customtag
short_description: Define custom tag table.
...
options:
  ...
  firewall_customtag:
    ...
    suboptions:
      abbreviation:
        type: str
        description: Custom tag name abbreviation.
      color:
        type: int
        description: Color of the custom tag on the GUI.
      comment:
        type: str
        description: Comment.
      fabric_force_sync:
...
def main():
    ...
    module_arg_spec = {
        ...
        'firewall_customtag': {
            ...
            'options': {
                'abbreviation': {'v_range': [['8.0.0', '']], 'type': 'str'},
                'color': {'v_range': [['8.0.0', '']], 'type': 'int'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_customtag'),
