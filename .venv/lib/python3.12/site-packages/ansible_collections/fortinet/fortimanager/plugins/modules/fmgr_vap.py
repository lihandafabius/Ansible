      ...
      dynamic_mapping:
        ...
        suboptions:
          ...
          rates_11n_ss12:
            ...
            choices: ['mcs0/1', 'mcs1/1', 'mcs2/1', 'mcs3/1', 'mcs4/1', 'mcs5/1', 'mcs6/1',
                      'mcs7/1', 'mcs8/2', 'mcs9/2', 'mcs10/2', 'mcs11/2', 'mcs12/2', 'mcs13/2',
                      'mcs14/2', 'mcs15/2']
          rates_11n_ss34:
          ...
          sae_groups:
            ...
            choices: ['1', '2', '5', '14', '15', '16', '17', '18', '19', '20', '21', '27', '28',
                      '29', '30', '31']
          sae_password:
          ...
          security:
            ...
            choices: ['None', 'WEP64', 'wep64', 'WEP128', 'wep128', 'WPA_PSK', 'WPA_RADIUS',
                      ...
                      'wpa2-only-personal', 'wpa2-only-enterprise', 'wpa-personal+captive-portal',
            ...
            'options': {
                ...
                'dynamic_mapping': {
                    ...
                    'options': {
                        ...
                        'sae-h2e-only': {'v_range': [['7.0.5', '7.0.16'], ['7.2.1', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                        'sae-pk': {'v_range': [['7.0.5', '7.0.16'], ['7.2.1', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                        'sae-private-key': {'v_range': [['7.0.5', '7.0.16'], ['7.2.1', '']], 'no_log': True, 'type': 'str'},
                        'sticky-client-threshold-6g': {'v_range': [['7.0.5', '7.0.16'], ['7.2.1', '']], 'type': 'str'},
                ...
                'me-disable-thresh': {'type': 'int'},
                'mesh-backhaul': {'choices': ['disable', 'enable'], 'type': 'str'},
                'mpsk': {'v_range': [['6.0.0', '7.6.7']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'mpsk-concurrent-clients': {'v_range': [['6.0.0', '7.6.7']], 'type': 'int'},
                'mpsk-key': {
                    'v_range': [['6.0.0', '7.6.7']],
                    'no_log': True,
                    'type': 'list',
                    'options': {
                        ...
                        'key-name': {'v_range': [['6.0.0', '7.6.7']], 'no_log': True, 'type': 'str'},
