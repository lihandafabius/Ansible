  ...
  extensioncontroller_extenderprofile:
    ...
    suboptions:
      ...
      model:
        type: str
        description: Model.
        choices: ['FX201E', 'FX211E', 'FX200F', 'FXA11F', 'FXE11F', 'FXA21F', 'FXE21F', 'FXA22F',
                  'FXE22F', 'FX212F', 'FX311F', 'FX312F', 'FX511F', 'FVG21F', 'FVA21F', 'FVG22F',
                  'FVA22F', 'FX04DA', 'FX04DN', 'FX04DI', 'FXR51G', 'FG', 'BS10FW', 'BS20GW',
                  'BS20GN', 'FXN51G', 'FXW51G', 'FVG51G', 'FXE11G', 'FX211G', 'FWE50G', 'FWA50G']
      name:
        type: str
        ...
        suboptions:
          ...
          country:
            ...
            choices: ['AL', 'DZ', 'AR', 'AM', 'AU', 'AT', 'AZ', 'BH', 'BD', 'BY', 'BE', 'BZ',
                      ...
                      'GT', 'HN', 'HK', 'HU', 'IS', 'IN', 'ID', 'IE', 'IL', 'IT', 'JM', 'JP',
                      'JO', 'KZ', 'KE', 'KR', 'KW', 'LV', 'LB', 'LI', 'LT', 'LU', 'MO', 'MK',
                      'MY', 'MT', 'MX', 'MC', 'MA', 'NP', 'NL', 'AN', 'NZ', 'NO', 'OM', 'PK',
                      'PA', 'PG', 'PE', 'PH', 'PL', 'PT', 'PR', 'QA', 'RO', 'RU', 'SA', 'SG',
                      'SK', 'SI', 'ZA', 'ES', 'LK', 'SE', 'CH', 'TW', 'TH', 'TT', 'TN', 'TR',
                      'AE', 'UA', 'GB', 'US', 'PS', 'UY', 'UZ', 'VE', 'VN', 'YE', 'ZW', 'NA',
                      'BS', 'VC', 'KH', 'MV', 'AF', 'NG', 'TZ', 'ZM', 'SN', 'CI', 'GH', 'CM',
                      'MW', 'AO', 'GA', 'ML', 'BJ', 'MG', 'TD', 'BW', 'LY', 'RW', 'MZ', 'GM',
                      'LS', 'MU', 'CG', 'UG', 'BF', 'SL', 'SO', 'CD', 'NE', 'CF', 'SZ', 'TG',
                      'LR', 'MR', 'DJ', 'RE', 'RS', 'ME', 'IQ', 'MD', 'KY', 'BB', 'BM', 'TC',
                      'VI', 'PM', 'MF', 'GD', 'IM', 'FO', 'GI', 'GL', 'TM', 'MN', 'VU', 'FJ',
                      'LA', 'GU', 'WF', 'MH', 'BT', 'FM', 'PF', 'NI', 'PY', 'HT', 'GY', 'AW',
                      'KN', 'GF', 'AS', 'MP', 'PW', 'MM', 'LC', 'GP', 'ET', 'SR', 'CX', 'DM',
                      'MQ', 'YT', 'BL', '--', 'TL']
          radio_1:
            aliases: ['radio-1']
            type: dict
            ...
            suboptions:
              ...
              channel:
                ...
                choices: ['CH1', 'CH2', 'CH3', 'CH4', 'CH5', 'CH6', 'CH7', 'CH8', 'CH9', 'CH10',
                          'CH11']
              extension_channel:
            ...
            'options': {
                ...
                'model': {
                    ...
                    'choices': [
                        ...
                        'FXW51G', 'FVG51G', 'FXE11G', 'FX211G', 'FWE50G', 'FWA50G'
                    ],
                    'type': 'str'
                },
                'name': {'v_range': [['7.2.1', '']], 'type': 'str'},
