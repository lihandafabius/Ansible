  ...
  pkg_firewall_policy:
    ...
    suboptions:
      action:
        ...
        choices: ['deny', 'accept', 'ipsec', 'ssl-vpn', 'redirect', 'isolate']
      app_category:
      ...
      disclaimer:
        ...
        choices: ['disable', 'enable', 'user', 'domain', 'policy']
      dlp_sensor:
        aliases: ['dlp-sensor']
        type: str
      ...
      geoip_match:
        ...
        choices: ['physical-location', 'registered-location']
      ...
      type:
        ...
        choices: ['explicit-web', 'transparent', 'explicit-ftp', 'ssh-tunnel', 'ssh', 'wanopt',
                  'access-proxy', 'ztna-proxy', 'explicit-web-connect', 'transparent-connect',
                  'llm-proxy']
      url_risk:
        aliases: ['url-risk']
        type: raw
      ...
      creation_time:
        ...
        type: int
        description: The date and time that the policy was created.
      custom_tags:
        aliases: ['custom-tags']
        type: raw
      ...
      fabric_policy:
        aliases: ['fabric-policy']
        type: dict
        description: Fabric policy.
        suboptions:
          from:
            type: raw
            description: (list) From device.
          to:
            type: raw
            description: (list) To device.
      skip_vrf_match:
        aliases: ['skip-vrf-match']
        type: str
        description: Enable/disable skipping VRF matching on reply direction.
        choices: ['disable', 'enable']
      ztna_destination:
        aliases: ['ztna-destination']
        type: raw
        description: (list) Configure ZTNA destinations.
      ztna_ems_tag6:
        aliases: ['ztna-ems-tag6']
        type: raw
        description: (list) Source ZTNA FortiClient EMS tag IPv6 names.
      object_position:
    ...
    module_arg_spec = {
        ...
        'pkg_firewall_policy': {
            ...
            'options': {
                ...
                'capture-packet': {'v_range': [['6.0.0', '7.2.0'], ['7.2.6', '7.2.12'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'comments': {'type': 'raw'},
                ...
                'groups': {'type': 'raw'},
                'gtp-profile': {'v_range': [['6.0.0', '7.2.0'], ['7.2.6', '7.2.12'], ['7.4.3', '']], 'type': 'str'},
                ...
                'mms-profile': {'v_range': [['6.0.0', '7.2.0'], ['7.2.6', '7.2.12'], ['7.4.3', '7.6.2']], 'type': 'str'},
                'name': {'type': 'str'},
                ...
                'tags': {'v_range': [['6.0.0', '6.4.15'], ['7.4.8', '7.4.11']], 'type': 'str'},
                ...
                'wanopt': {'v_range': [['6.0.0', '7.2.0'], ['7.2.6', '7.2.12'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'wanopt-detection': {
                    'v_range': [['6.0.0', '7.2.0'], ['7.2.6', '7.2.12'], ['7.4.3', '']],
                    'choices': ['active', 'passive', 'off'],
                    'type': 'str'
                ...
                'wanopt-peer': {'v_range': [['6.0.0', '7.2.0'], ['7.2.6', '7.2.12'], ['7.4.3', '']], 'type': 'str'},
                'wanopt-profile': {'v_range': [['6.0.0', '7.2.0'], ['7.2.6', '7.2.12'], ['7.4.3', '']], 'type': 'str'},
                'wccp': {'choices': ['disable', 'enable'], 'type': 'str'},
                'webcache': {'v_range': [['6.0.0', '7.2.0'], ['7.2.6', '7.2.12'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'webcache-https': {
                    'v_range': [['6.0.0', '7.2.0'], ['7.2.6', '7.2.12'], ['7.4.3', '']],
                    'choices': ['disable', 'ssl-server', 'any', 'enable'],
                    'type': 'str'
                ...
                'np-acceleration': {'v_range': [['6.2.0', '7.2.0'], ['7.2.6', '7.2.12'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                ...
                'pfcp-profile': {'v_range': [['7.0.1', '7.2.0'], ['7.2.6', '7.2.12'], ['7.4.3', '']], 'type': 'str'},
                ...
                'access-proxy': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'type': 'raw'},
                'detect-https-in-http-request': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'device-ownership': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'dynamic-bypass': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'explicit-web-proxy': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'type': 'raw'},
                'extended-log': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'force-proxy': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'http-tunnel-auth': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'https-sub-category': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'ia-profile': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'type': 'raw'},
                'implicit-proxy-detection': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'isolator-profile': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'type': 'raw'},
                'isolator-server': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'type': 'raw'},
                'max-session-per-user': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'type': 'int'},
                'pass-through': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'redirect-profile': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'type': 'raw'},
                'reverse-cache': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'ssh-policy-check': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'transparent': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'type': {
                ...
                'url-risk': {'v_range': [['7.4.8', '7.4.11'], ['7.6.4', '']], 'type': 'raw'},
                ...
                'creation-time': {'v_range': [['7.6.7', '']], 'type': 'int'},
                ...
                'fabric-policy': {
                    'v_range': [['8.0.0', '']],
                    'type': 'dict',
                    'options': {'from': {'v_range': [['8.0.0', '']], 'type': 'raw'}, 'to': {'v_range': [['8.0.0', '']], 'type': 'raw'}}
                },
                'skip-vrf-match': {'v_range': [['8.0.0', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'ztna-destination': {'v_range': [['8.0.0', '']], 'type': 'raw'},
                'ztna-ems-tag6': {'v_range': [['8.0.0', '']], 'type': 'raw'},
