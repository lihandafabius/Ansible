...
DOCUMENTATION = '''
---
module: fmgr_user_aci
short_description: User aci
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'user_aci'),
