  ...
  pkg_header_policy:
    ...
    suboptions:
      ...
      active_auth_method:
        ...
        choices: ['ntlm', 'basic', 'digest', 'form']
      anti_replay:
        aliases: ['anti-replay']
        type: str
      ...
      auth_method:
        ...
        choices: ['basic', 'digest', 'ntlm', 'fsae', 'form', 'fsso', 'rsso']
      auth_path:
        aliases: ['auth-path']
        type: str
      ...
      forticlient_compliance_devices:
        ...
        choices: ['windows-pc', 'mac', 'iphone-ipad', 'android']
    ...
    module_arg_spec = {
        ...
        'pkg_header_policy': {
            ...
            'options': {
                ...
                'uuid-idx': {'v_range': [['7.0.1', '7.6.7']], 'type': 'int'},
                ...
                'url-risk': {'v_range': [['7.4.4', '7.4.11'], ['7.6.2', '']], 'type': 'raw'},
                ...
                'https-sub-category': {'v_range': [['7.4.7', '7.4.11'], ['7.6.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
