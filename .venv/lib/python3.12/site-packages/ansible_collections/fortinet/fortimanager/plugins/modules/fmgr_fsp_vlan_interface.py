  ...
  fsp_vlan_interface:
    ...
    suboptions:
      ...
      forward_error_correction:
        ...
        choices: ['disable', 'enable', 'rs-fec', 'base-r-fec', 'fec-cl91', 'fec-cl74', 'rs-544',
                  'none', 'cl91-rs-fec', 'cl74-fc-fec', 'auto', 'rs-fec544', 'default']
      fp_anomaly:
        aliases: ['fp-anomaly']
        type: list
        elements: str
        ...
        choices: ['drop_tcp_fin_noack', 'pass_winnuke', 'pass_tcpland', 'pass_udpland',
                  ...
                  'pass_ipstream', 'pass_ipsecurity', 'pass_iptimestamp', 'pass_ipunknown_option',
                  'pass_ipunknown_prot', 'pass_icmp_frag', 'pass_tcp_no_flag',
                  'pass_tcp_fin_noack', 'drop_winnuke', 'drop_tcpland', 'drop_udpland',
                  'drop_icmpland', 'drop_ipland', 'drop_iprr', 'drop_ipssrr', 'drop_iplsrr',
                  'drop_ipstream', 'drop_ipsecurity', 'drop_iptimestamp', 'drop_ipunknown_option',
      ...
      mediatype:
        ...
        choices: ['serdes-sfp', 'sgmii-sfp', 'cfp2-sr10', 'cfp2-lr4', 'serdes-copper-sfp', 'sr',
                  'cr', 'lr', 'qsfp28-sr4', 'qsfp28-lr4', 'qsfp28-cr4', 'sr4', 'cr4', 'lr4',
                  'none', 'gmii', 'sgmii', 'sr2', 'lr2', 'cr2', 'sr8', 'lr8', 'cr8', 'dr',
                  'sr-lr', 'kr']
      member:
        type: raw
      ...
      type:
        type: str
        description: Type.
        choices: ['physical', 'vlan', 'aggregate', 'redundant', 'tunnel', 'wireless', 'vdom-link',
                  'loopback', 'switch', 'hard-switch', 'hdlc', 'vap-switch', 'wl-mesh',
                  'fortilink', 'switch-vlan', 'fctrl-trunk', 'tdm', 'fext-wan', 'vxlan',
                  'emac-vlan', 'geneve', 'ssl', 'lan-extension']
      username:
        type: str
      ...
      wifi_security:
        ...
        choices: ['None', 'WEP64', 'wep64', 'WEP128', 'wep128', 'WPA_PSK', 'WPA_RADIUS', 'WPA',
                  'WPA2', 'WPA2_AUTO', 'open', 'wpa-personal', 'wpa-enterprise',
      ...
      managed_subnetwork_size:
        ...
        choices: ['256', '512', '1024', '2048', '4096', '8192', '16384', '32768', '65536', '32',
                  '64', '128', '4', '8', '16', '131072', '262144', '524288', '1048576', '2097152',
            ...
            'options': {
                ...
                'speed': {
                    'choices': [
                        ...
                        '50000auto', '200Gfull', '200Gauto', '100auto', 'sgmii-auto', 'sgmii-100full'
                    ],
                    'type': 'str'
                },
                ...
                'arp-egress-cos': {'v_range': [['8.0.0', '']], 'choices': ['cos0', 'cos1', 'cos2', 'cos3', 'cos4', 'cos5', 'cos6', 'cos7'], 'type': 'str'},
                'dhcp-egress-cos': {
                    'v_range': [['8.0.0', '']],
                    'choices': ['cos0', 'cos1', 'cos2', 'cos3', 'cos4', 'cos5', 'cos6', 'cos7'],
                    'type': 'str'
