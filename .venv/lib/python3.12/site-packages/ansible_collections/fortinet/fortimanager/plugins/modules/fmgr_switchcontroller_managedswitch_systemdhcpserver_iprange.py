...
DOCUMENTATION = '''
---
module: fmgr_switchcontroller_managedswitch_systemdhcpserver_iprange
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: DHCP IP range configuration.
      fortinet.fortimanager.fmgr_switchcontroller_managedswitch_systemdhcpserver_iprange:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_managedswitch_systemdhcpserver_iprange'),
