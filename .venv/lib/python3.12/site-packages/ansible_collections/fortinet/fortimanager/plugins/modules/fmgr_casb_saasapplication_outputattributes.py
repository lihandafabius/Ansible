...
DOCUMENTATION = '''
---
module: fmgr_casb_saasapplication_outputattributes
...
- name: Example playbook (generated based on argument schema)
  ...
  gather_facts: false
  tasks:
    - name: SaaS application output attributes.
      fortinet.fortimanager.fmgr_casb_saasapplication_outputattributes:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'casb_saasapplication_outputattributes'),
