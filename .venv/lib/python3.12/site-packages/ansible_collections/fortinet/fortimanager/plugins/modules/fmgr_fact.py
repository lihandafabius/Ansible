    ...
    suboptions:
      selector:
        ...
        choices:
          ...
          - 'system_locallog_tacacsaccounting_filter'
...
def main():
    facts_metadata = {
        ...
        'devprof_system_replacemsg_devicedetectionportal': {
            ...
            'v_range': [['6.0.0', '6.2.5'], ['6.2.7', '6.4.1'], ['6.4.3', '7.6.7']]
        },
        'devprof_system_replacemsg_ec': {
            'params': ['adom', 'devprof'],
            'urls': [
            ...
            'v_range': [['6.0.0', '6.2.5'], ['6.2.7', '6.4.1'], ['6.4.3', '7.2.1'], ['7.4.8', '7.4.11']]
        },
        'devprof_system_replacemsg_fortiguardwf': {
            'params': ['adom', 'devprof'],
            'urls': [
        ...
        'devprof_system_template_interface': {
            'params': ['adom', 'devprof', 'interface'],
            'urls': [
                '/pm/config/adom/{adom}/devprof/{devprof}/system/template/interface',
                '/pm/config/adom/{adom}/devprof/{devprof}/system/template/interface/{interface}'
            ],
            'v_range': [['7.6.5', '']]
        },
        'devprof_system_template_interface_iprange': {
            'params': ['adom', 'devprof', 'interface', 'ip-range'],
            'urls': [
                '/pm/config/adom/{adom}/devprof/{devprof}/system/template/interface/{interface}/ip-range',
                '/pm/config/adom/{adom}/devprof/{devprof}/system/template/interface/{interface}/ip-range/{ip-range}'
            ],
            'v_range': [['7.6.5', '']]
        },
        'diameterfilter_profile': {
        ...
        'firewall_customtag': {
            ...
            'urls': [
                '/pm/config/adom/{adom}/obj/firewall/custom-tag',
                '/pm/config/adom/{adom}/obj/firewall/custom-tag/{custom-tag}',
                '/pm/config/global/obj/firewall/custom-tag',
        ...
        'fmg_script_schedule': {
            'params': ['adom', 'schedule', 'script'],
            'urls': [
                '/pm/config/adom/{adom}/obj/fmg/script/{script}/schedule',
                '/pm/config/adom/{adom}/obj/fmg/script/{script}/schedule/{schedule}',
                '/pm/config/global/obj/fmg/script/{script}/schedule',
                '/pm/config/global/obj/fmg/script/{script}/schedule/{schedule}'
            ],
            'v_range': [['7.6.5', '']]
        },
        'fmg_variable': {
        ...
        'pkg_footer_consolidated_policy': {
            ...
            'v_range': [['7.0.5', '7.0.16'], ['7.2.2', '7.6.2']]
        },
        'pkg_footer_policy': {
            'params': ['adom', 'pkg', 'policy'],
            'urls': [
        ...
        'pkg_footer_policy6': {
            ...
            'v_range': [['7.0.5', '7.0.16'], ['7.2.2', '7.6.7']]
        },
        'pkg_footer_policy6_identitybasedpolicy6': {
        ...
        'pm_config_pblock_firewall_localinpolicy6': {
            ...
            'urls': [
                '/pm/config/adom/{adom}/pblock/{pblock}/firewall/local-in-policy6',
        ...
        'pm_pkg_schedule': {
            ...
            'v_range': [['6.0.0', '7.4.10'], ['7.6.0', '7.6.6']]
        },
        'pm_wanprof': {
            'params': ['adom', 'pkg_path'],
            'urls': [
        ...
        'switchcontroller_managedswitch_dhcpsnoopingstaticclient': {
            ...
            'v_range': [['7.2.2', '7.4.10'], ['7.6.0', '7.6.6']]
        },
        'switchcontroller_managedswitch_ipsourceguard': {
        ...
        'switchcontroller_managedswitch_routeoffloadrouter': {
            ...
            'v_range': [['7.4.1', '7.4.10'], ['7.6.0', '7.6.6']]
        },
        'switchcontroller_managedswitch_routerstatic': {
        ...
        'switchcontroller_managedswitch_vlan': {
            ...
            'v_range': [['7.4.2', '7.4.10'], ['7.6.0', '7.6.6']]
        },
        'switchcontroller_ptp_profile': {
            'params': ['adom', 'profile'],
            'urls': [
        ...
        'system_csf_trustedlist_adom': {
            'params': ['adom', 'trusted-list'],
            'urls': [
                '/cli/global/system/csf/trusted-list/{trusted-list}/adom',
                '/cli/global/system/csf/trusted-list/{trusted-list}/adom/{adom}'
            ],
            'v_range': [['7.6.7', '']]
        },
        'system_customlanguage': {
        ...
        'system_objecttag': {
            ...
            'v_range': [['6.2.0', '6.4.15'], ['7.4.8', '7.4.11']]
        },
        'system_objecttagging': {
        ...
        'user_aci': {
            'params': ['aci', 'adom'],
            'urls': [
                '/pm/config/adom/{adom}/obj/user/aci',
                '/pm/config/adom/{adom}/obj/user/aci/{aci}',
                '/pm/config/global/obj/user/aci',
        ...
        'user_azure_rule': {
            ...
            'urls': [
                '/pm/config/adom/{adom}/obj/user/azure/{azure}/rule',
                '/pm/config/adom/{adom}/obj/user/azure/{azure}/rule/{rule}',
                '/pm/config/global/obj/user/azure/{azure}/rule',
        ...
        'user_guardicore': {
            ...
            'urls': [
                '/pm/config/adom/{adom}/obj/user/guardicore',
                '/pm/config/adom/{adom}/obj/user/guardicore/{guardicore}',
                '/pm/config/global/obj/user/guardicore',
