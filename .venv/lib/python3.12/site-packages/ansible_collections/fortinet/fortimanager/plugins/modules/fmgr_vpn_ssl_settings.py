    ...
    suboptions:
      ...
      banned_cipher:
        ...
        choices: ['RSA', 'DH', 'DHE', 'ECDH', 'ECDHE', 'DSS', 'ECDSA', 'AES', 'AESGCM',
                  'CAMELLIA', '3DES', 'SHA1', 'SHA256', 'SHA384', 'STATIC', 'CHACHA20', 'ARIA',
                  'AESCCM']
      check_referer:
      ...
      port_precedence:
        ...
        type: str
        description: Enable/disable, Enable means that if SSL VPN connections are allowed on an interface admin GUI connections are blocked on that int...
        choices: ['disable', 'enable']
      reqclientcert:
        type: str
        ...
        'vpn_ssl_settings': {
            ...
            'options': {
                ...
                'route-source-interface': {
                    'v_range': [['6.2.6', '6.2.13'], ['6.4.2', '7.2.0'], ['7.4.8', '7.4.11']],
                    'choices': ['disable', 'enable'],
                    'type': 'str'
                },
                ...
                'tlsv1-0': {'v_range': [['6.2.6', '6.2.13'], ['6.4.2', '7.2.1'], ['7.4.8', '7.4.11']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'tlsv1-1': {'v_range': [['6.2.6', '6.2.13'], ['6.4.2', '7.2.1'], ['7.4.8', '7.4.11']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'tlsv1-2': {'v_range': [['6.2.6', '6.2.13'], ['6.4.2', '7.2.1'], ['7.4.8', '7.4.11']], 'choices': ['disable', 'enable'], 'type': 'str'},
                ...
                'ssl-big-buffer': {
                    'v_range': [['6.2.6', '6.2.13'], ['6.4.2', '6.4.15'], ['7.4.8', '7.4.11']],
                    'choices': ['disable', 'enable'],
                    'type': 'str'
                },
