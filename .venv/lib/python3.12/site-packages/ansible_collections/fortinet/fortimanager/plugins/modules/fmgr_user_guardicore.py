...
DOCUMENTATION = '''
---
module: fmgr_user_guardicore
short_description: User guardicore
...
def main():
    ...
    module_arg_spec = {
        ...
        'user_guardicore': {
            ...
            'options': {
                ...
                'filters': {'v_range': [['8.0.0', '']], 'type': 'list', 'elements': 'str'},
                ...
                'scheme': {'v_range': [['8.0.0', '']], 'type': 'str'},
                'server': {'v_range': [['8.0.0', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'user_guardicore'),
