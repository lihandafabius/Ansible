  ...
  ztna_webportal:
    ...
    suboptions:
      ...
      theme:
        ...
        choices: ['melongene', 'mariner', 'neutrino', 'jade', 'graphite', 'dark-matter', 'onyx',
                  'eclipse', 'jet-stream', 'security-fabric']
      vip:
        type: list
        elements: str
    ...
    module_arg_spec = {
        ...
        'ztna_webportal': {
            ...
            'options': {
                ...
                'ak-manager': {'v_range': [['7.6.7', '']], 'choices': ['disable', 'enable'], 'type': 'str'}
            }
        }
    }
