    ...
    - name: Configure IPv4/IPv6 policies.
      fortinet.fortimanager.fmgr_pm_config_pblock_firewall_policy:
        ...
        pm_config_pblock_firewall_policy:
          ...
          #   from: <list or string>
          #   to: <list or string>
          # skip_vrf_match: <value in [disable, enable]>
          # ztna_destination: <list or string>
          # ztna_ems_tag6: <list or string>
'''
    ...
    module_arg_spec = {
        ...
        'pm_config_pblock_firewall_policy': {
            ...
            'options': {
                ...
                'cifs-profile': {'v_range': [['7.0.3', '7.6.7']], 'type': 'str'},
                ...
                'spamfilter-profile': {'v_range': [['7.0.3', '7.2.1'], ['7.4.8', '7.4.11']], 'type': 'str'},
                'scan-botnet-connections': {
                    'v_range': [['7.0.3', '7.2.1'], ['7.4.8', '7.4.11']],
                    'choices': ['disable', 'block', 'monitor'],
                    'type': 'str'
                },
                ...
                'tags': {'v_range': [['7.4.8', '7.4.11']], 'type': 'raw'},
