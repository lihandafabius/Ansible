    ...
    suboptions:
      ...
      system_support_fgt:
        ...
        description:
          ...
          - '6.'
          - '6.'
        choices: ['5.4', '5.6', '6.0', '6.2', '6.4', '7.0', '7.2', '7.4', '7.6', '5.x', '6.x',
                  '7.x', '8.0']
      system_support_fml:
      ...
      system_support_fai:
        ...
        description:
          ...
          - '7.'
        choices: ['7.x']
      controller_contract_download:
        aliases: ['controller-contract-download']
        type: str
        description: Controller contract download.
        choices: ['disable', 'enable']
'''
    ...
    module_arg_spec = {
        'fmupdate_fdssetting': {
            ...
            'options': {
                ...
                'system-support-fgt': {
                    'type': 'list',
                    'choices': ['5.4', '5.6', '6.0', '6.2', '6.4', '7.0', '7.2', '7.4', '7.6', '5.x', '6.x', '7.x', '8.0'],
                    'elements': 'str'
                },
                ...
                'controller-contract-download': {'v_range': [['7.6.7', '']], 'choices': ['disable', 'enable'], 'type': 'str'}
            }
        }
    }
