  ...
  user_radius:
    ...
    suboptions:
      ...
      auth_type:
        ...
        choices: ['pap', 'chap', 'ms_chap', 'ms_chap_v2', 'auto']
      class:
        type: raw
        ...
        suboptions:
          ...
          dp_carrier_endpoint_attribute:
            ...
            choices: ['User-Name', 'User-Password', 'CHAP-Password', 'NAS-IP-Address', 'NAS-Port',
                      ...
                      'State', 'Class', 'Vendor-Specific', 'Session-Timeout', 'Idle-Timeout',
          ...
          dp_http_header_fallback:
            ...
            choices: ['ip-header-address', 'default-profile']
          ...
          dp_log_dyn_flags:
            ...
            choices: ['none', 'protocol-error', 'profile-missing', 'context-missing',
          ...
          ep_missing_header_fallback:
            ...
            choices: ['session-ip', 'policy-profile']
          ep_profile_query_type:
            aliases: ['ep-profile-query-type']
            type: str
            description: Ep profile query type.
            choices: ['session-ip', 'extract-ip', 'extract-carrier-endpoint']
          h3c_compatibility:
          ...
          rsso_endpoint_attribute:
            ...
            choices: ['User-Name', 'User-Password', 'CHAP-Password', 'NAS-IP-Address', 'NAS-Port',
                      ...
                      'Login-IP-Host', 'Login-Service', 'Login-TCP-Port', 'Reply-Message',
                      'Callback-Number', 'Callback-Id', 'Framed-Route', 'Framed-IPX-Network',
                      'State', 'Class', 'Session-Timeout', 'Idle-Timeout', 'Termination-Action',
          ...
          switch_controller_service_type:
            ...
            choices: ['login', 'framed', 'callback-login', 'callback-framed', 'outbound',
          ...
          nas_id_type:
            ...
            choices: ['legacy', 'custom', 'hostname']
          ca_cert:
            aliases: ['ca-cert']
            type: str
      ...
      radius_coa:
        aliases: ['radius-coa']
        type: str
        description: Enable to allow a mechanism to change the attributes of an authentication, authorization, and accounting session after it is authe...
        choices: ['disable', 'enable']
      radius_port:
        aliases: ['radius-port']
        type: int
      ...
      rsso_endpoint_attribute:
        ...
        choices: ['User-Name', 'User-Password', 'CHAP-Password', 'NAS-IP-Address', 'NAS-Port',
                  ...
                  'Called-Station-Id', 'Calling-Station-Id', 'NAS-Identifier', 'Proxy-State',
                  'Login-LAT-Service', 'Login-LAT-Node', 'Login-LAT-Group',
                  'Framed-AppleTalk-Link', 'Framed-AppleTalk-Network', 'Framed-AppleTalk-Zone',
                  ...
                  'Acct-Multi-Session-Id', 'Acct-Link-Count', 'CHAP-Challenge', 'NAS-Port-Type',
      ...
      rsso_log_flags:
        ...
        choices: ['none', 'protocol-error', 'profile-missing', 'context-missing',
                  'accounting-stop-missed', 'accounting-event', 'radiusd-other', 'endpoint-block']
      rsso_log_period:
        aliases: ['rsso-log-period']
        type: int
