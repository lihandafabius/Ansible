    ...
    suboptions:
      ...
      speed:
        ...
        choices: ['auto', '10full', '10half', '100full', '100half', '1000full', '10000full',
                  ...
                  '100FX-half', '100FX-full', '100000full', '2500full', '25000full', '50000full',
                  '40000auto', '10000cr', '10000sr', '100000sr4', '100000cr4', '25000cr4',
                  '25000sr4', '5000full', '2500auto', '5000auto', '1000full-fiber', '40000sr4',
                  '40000cr4', '25000cr', '25000sr', '50000cr', '50000sr', 'sgmii-auto',
                  'detect-by-module']
      speed_mask:
        aliases: ['speed-mask']
        type: int
...
def main():
            ...
            'options': {
                ...
                'speed': {
                    ...
                    'choices': [
                        ...
                        '40000cr4', '25000cr', '25000sr', '50000cr', '50000sr', 'sgmii-auto', 'detect-by-module'
                    ],
                    'type': 'str'
                },
    ...
    fmgr = NAPIManager('full crud', module_arg_spec, urls_list,
                       'port-name', 'data', module, connection)
    fmgr.process_crud()
