  ...
  dvmdb_device:
    ...
    suboptions:
      ...
      dev_status:
        ...
        choices: ['none', 'unknown', 'checkedin', 'inprogress', 'installed', 'aborted', 'sched',
                  'retry', 'canceled', 'pending', 'retrieved', 'changed_conf', 'sync_fail',
      ...
      ha_mode:
        ...
        choices: ['standalone', 'AP', 'AA', 'ELBC', 'DUAL', 'enabled', 'unknown', 'fmg-enabled',
                  'autoscale']
      ha_slave:
        type: list
        elements: dict
