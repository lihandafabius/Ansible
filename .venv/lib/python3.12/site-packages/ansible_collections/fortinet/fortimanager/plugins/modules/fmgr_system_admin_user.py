    ...
    suboptions:
      ...
      user_type:
        ...
        description:
          ...
          - pki-auth - PKI user.
          - group - Group user.
        choices: ['local', 'radius', 'ldap', 'tacacs-plus', 'pki-auth', 'group', 'sso', 'api']
      userid:
        type: str
      ...
      user_theme:
        ...
        choices: ['blue', 'green', 'red', 'melongene', 'spring', 'summer', 'autumn', 'winter',
                  'circuit-board', 'calla-lily', 'binary-tunnel', 'mars', 'blue-sea',
                  'technology', 'landscape', 'twilight', 'canyon', 'northern-light', 'astronomy',
                  'fish', 'penguin', 'mountain', 'panda', 'parrot', 'cave', 'zebra',
                  'contrast-dark', 'mariner', 'jade', 'neutrino', 'dark-matter', 'forest', 'cat',
                  'graphite']
      adom_access:
        aliases: ['adom-access']
        type: str
    ...
    module_arg_spec = {
        'system_admin_user': {
            ...
            'options': {
                ...
                'old-password': {'v_range': [['7.2.11', '7.2.12'], ['7.4.7', '7.4.11'], ['7.6.3', '']], 'no_log': True, 'type': 'str'},
