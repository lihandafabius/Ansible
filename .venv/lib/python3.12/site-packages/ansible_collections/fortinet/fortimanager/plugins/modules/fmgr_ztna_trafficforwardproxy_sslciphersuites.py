...
DOCUMENTATION = '''
---
module: fmgr_ztna_trafficforwardproxy_sslciphersuites
short_description: Ztna traffic forward proxy ssl cipher suites
...
- name: Example playbook (generated based on argument schema)
  ...
  gather_facts: false
  tasks:
    - name: Ztna traffic forward proxy ssl cipher suites
      fortinet.fortimanager.fmgr_ztna_trafficforwardproxy_sslciphersuites:
